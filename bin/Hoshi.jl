...
module Hoshi
    ...
    type Parser
        ...
        function Parser(args...)
            ...
            if length(args) == 0
                ...
                this.this_ptr = ccall((:jl_parser_new_parser, "hoshi"),
                                      Ptr{Void},
                                      ())
            ...
            elseif length(args) == 1 && typeof(args[1]) == Parser
                ...
                this.this_ptr = ccall((:jl_parser_clone_parser, "hoshi"),
                                      Ptr{Void},
                                      (Ptr{Void},),
                                      args[1].this_ptr)
            ...
            finalizer(this, function(in::Parser)
                ...
                ccall((:jl_parser_delete_parser, "hoshi"),
                      Void,
                      (Ptr{Void},),
                      this.this_ptr)
            ...
            this.is_grammar_loaded = function()
                ...
                result::UInt8 = ccall((:jl_parser_is_grammar_loaded, "hoshi"),
                                      UInt8,
            ...
            this.is_grammar_failed = function()
                ...
                result::UInt8 = ccall((:jl_parser_is_grammar_failed, "hoshi"),
                                      UInt8,
                                      (Ptr{Void}, Ptr{Cptrdiff_t}),
                                      this.this_ptr, 
                                      exception_handle)
            ...
            this.is_source_loaded = function()
                ...
                result::UInt8 = ccall((:jl_parser_is_source_loaded, "hoshi"),
                                      UInt8,
                                      (Ptr{Void}, Ptr{Cptrdiff_t}),
                                      this.this_ptr, 
                                      exception_handle)
            ...
            this.is_source_failed = function()
                ...
                result::UInt8 = ccall((:jl_parser_is_source_failed, "hoshi"),
                                      UInt8,
                                      (Ptr{Void}, Ptr{Cptrdiff_t}),
                                      this.this_ptr, 
                                      exception_handle)
            ...
            this.generate = function(source::String, args...)
                ...
                ccall((:jl_parser_generate, "hoshi"),
                      Void,
            ...
            this.get_encoded_ast = function()
                ...
                ccall((:jl_parser_get_encoded_ast, "hoshi"),
                      Void,
            ...
            this.get_encoded_kind_map = function()
                ...
                ccall((:jl_parser_get_encoded_kind_map, "hoshi"),
                      Void,
                      (Ptr{Void}, Ptr{Cptrdiff_t}, Ptr{Cptrdiff_t}),
                      this.this_ptr, 
                      exception_handle, 
            ...
            this.add_error = function(error_type::Int32, 
                ...
                ccall((:jl_parser_add_error, "hoshi"),
                      Void,
            ...
            this.get_error_count = function()
                ...
                result::Int32 = ccall((:jl_parser_get_error_count, "hoshi"),
                                      Int32,
                                      (Ptr{Void}, Ptr{Cptrdiff_t}),
                                      this.this_ptr, 
                                      exception_handle)
            ...
            this.get_warning_count = function()
                ...
                result::Int32 = ccall((:jl_parser_get_warning_count, "hoshi"),
                                      Int32,
                                      (Ptr{Void}, Ptr{Cptrdiff_t}),
                                      this.this_ptr, 
                                      exception_handle)
            ...
            this.get_encoded_error_messages = function()
                ...
                ccall((:jl_parser_get_encoded_error_messages, "hoshi"),
                      Void,
                      (Ptr{Void}, Ptr{Cptrdiff_t}, Ptr{Cptrdiff_t}),
                      this.this_ptr, 
                      exception_handle, 
            ...
            this.get_source_list = function(source::String, args...)
                ...
                ccall((:jl_parser_get_source_list, "hoshi"),
                      Void,
    ...
    function string_result_in(result_ptr::Ptr{Cptrdiff_t})
        ...
        length = ccall((:jl_get_string_length, "hoshi"),
                       Int32,
                       (Ptr{Cptrdiff_t},),
                       result_ptr)
        ...
        ccall((:jl_get_string_string, "hoshi"),
              Void,
    ...
    function check_exceptions(exception_handle)
        ...
        exception_type = ccall((:jl_get_exception_type, "hoshi"),
                               Int32,
                               (Ptr{Cptrdiff_t},),
                               exception_handle)
        ...
        length = ccall((:jl_get_exception_length, "hoshi"),
                       Int32,
                       (Ptr{Cptrdiff_t},),
                       exception_handle)
        ...
        ccall((:jl_get_exception_string, "hoshi"),
              Void,
              (Ptr{Cptrdiff_t}, Ptr{Uint8}),
              exception_handle,
              convert(Ptr{Uint8}, buf))
