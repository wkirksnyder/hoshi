...
static const char* grammar_str =
{
    ...
    "{','|':'|'-'|'>>'|'<<'|'$'|']'|'rules'|'%'|'@'|'+'|'='|','|'*'|';'|<int"
    "eger>|'<'|'>'|'/='|'>='|'<='|'template'|'action'|'regex'|'error'|'descr"
    "iption'|'precedence'|'lexeme'|'ignore'|'empty'|'/'|'token_count'|'!'|'t"
    "okens'|'?'|'['|'case_sensitive'|'conflicts'|'error_recovery'|'_'|'keep_"
    "whitespace'|'lookaheads'|'.'|'dump_stack'|<triplestring>|'::^'|'::='|'t"
    "rue'|'false'|':='|'=>'|'options'|||||||||||||||||||||||||||||||||||||||"
    "|||||||||||||||||||||||||||||*error*|<stringerror>|<triplestringerror>|"
    ...
    "||!!||:!||P]I=||?!||?!||P]I=||A!||A!||PBO=||B!||Z!||P]I=||N!||) 0 (|4/V"
    "!0|%||P||Y||P]I=||!!||:!||P]I=||?!||?!||P]I=||A!||A!||PAO=||B!||Z!||P]I"
    "=||F!||&   &|C/V!|PP!/||Z\"| #|\"#||Y\"|\\\"|##|}+|!||!|!||||||||||||||"
    "|||||!|!||||||||||||||||||||||||||||!|||||||||||||?!||||||||P!|?\"|V!||"
    "||||A!||||||||A!||||||||P|]#|V!||||||B!||||||||Z!||||||||P!|?\"|V!|||||"
    "!|!|||!|!|},|/\"|}-|!|#|!||!||\"|\"||#|#|#|#|#|\"|\"||!|#|\"||#|#|#|#|\""
    ...
    "|\"|\"|!|\"|\"|\"||#|!||!||\"|!|#|!|\"||$|\"|#|!|#|!|#|#|#|#|#|#|!|#|#|"
    "!|#|#|!|\"|\"|!|#|!|!|!|!|!|!|!|!|!|!|!|!|}.|!\"|P!|U!|U!|V!|V!|K!|Y!|Y"
    "!|Z!|Z!|Z!|Z!|Z!|[!|\\!|\\!|]!|]!|?!|?!|T!|T!|T!|T!|I!|I!|C!|9!|T!|T!|T"
    "!|T!|T!|Q!|R!|R!|S!|S!|D!|2!|2!|2!|3!|G!|X!|G!|/!|0!|0!|+!|+!|+!|+!|,!|"
    ",!|,!|D!|F!|F!|@!|J!|J!|A!|A!|H!|%!|%!|&!|\"!|7!|7!|7!|*!|;!|<!|E!|M!|N"
    "!|N!|E!|;!|5!|)!|)!|)!|5!|5!|5!|5!|5!|5!|5!|4!|B!|L!|B!|>!|:!|:!|O!|O!|"
    "(!|(!|=!|6!|8!|8!|W!|W!|.!|.!|'!|'!|$!|$!|$!|$!|$!|$!|$!| !| !| !|_|_|_"
    "|^|^|^|]|]|]|]|!!|!!|#!|\\|1!|1!|-!|-!|[|}/|*accept* ::= Grammar|Gramma"
    "r ::= Grammar:1 Grammar:2 RuleSection|Grammar:1 ::= OptionSection|Gramm"
    "ar:1 ::= *epsilon*|Grammar:2 ::= TokenSection|Grammar:2 ::= *epsilon*|O"
    "ptionSection ::= 'options' OptionSection:1|OptionSection:1 ::= OptionSe"
    "ction:1 OptionSpec|OptionSection:1 ::= *epsilon*|OptionSpec ::= 'lookah"
    "eads' '=' IntegerValue|OptionSpec ::= 'conflicts' '=' IntegerValue|Opti"
    "onSpec ::= 'error_recovery' '=' BooleanValue|OptionSpec ::= 'keep_white"
    "space' '=' BooleanValue|OptionSpec ::= 'case_sensitive' '=' BooleanValu"
    "e|TokenSection ::= 'tokens' TokenSection:1|TokenSection:1 ::= TokenSect"
    "ion:1 TokenSpec|TokenSection:1 ::= *epsilon*|TokenSpec ::= TerminalSymb"
    "ol|TokenSpec ::= TerminalSymbol ':' TokenSpec:1|TokenSpec:1 ::= TokenSp"
    "ec:1 TokenOption|TokenSpec:1 ::= *epsilon*|TokenOption ::= 'template' '"
    "=' TerminalSymbol|TokenOption ::= 'description' '=' StringValue|TokenOp"
    "tion ::= 'regex' '=' RegexString|TokenOption ::= 'regex' '=' TokenOptio"
    "n:1|TokenOption:1 ::= TokenOption:1 TokenRegex|TokenOption:1 ::= TokenR"
    "egex|TokenRegex ::= '[' ActionExpression ']' '=>' RegexString|RegexStri"
    "ng ::= StringValue|TokenOption ::= 'precedence' '=' IntegerValue|TokenO"
    "ption ::= 'action' '=' '[' ActionStatementList ']'|TokenOption ::= 'lex"
    "eme' '=' BooleanValue|TokenOption ::= 'ignore' '=' BooleanValue|TokenOp"
    "tion ::= 'error' '=' StringValue|RuleSection ::= RuleSection:1 RuleSect"
    "ion:2|RuleSection:1 ::= 'rules'|RuleSection:1 ::= *epsilon*|RuleSection"
    ":2 ::= RuleSection:2 Rule|RuleSection:2 ::= Rule|Rule ::= NonterminalRe"
    "ference '::=' RuleRhsList ReduceActions|ReduceActions ::= ':' ReduceAst"
    "Action ':' ReduceGuardAction|ReduceActions ::= ':' ReduceAstAction|Redu"
    "ceActions ::= *epsilon*|RuleRhsList ::= RuleRhs RuleRhsList:1|RuleRhsLi"
    "st:1 ::= RuleRhsList:1 RuleRhsList:2|RuleRhsList:2 ::= '{',' RuleRhs|Ru"
    "leRhsList:1 ::= *epsilon*|RuleRhs ::= RuleRhs:1|RuleRhs:1 ::= RuleRhs:1"
    " RuleSequenceTerm|RuleRhs:1 ::= RuleSequenceTerm|RuleSequenceTerm ::= R"
    "uleUnopTerm '*'|RuleSequenceTerm ::= RuleUnopTerm '+'|RuleSequenceTerm "
    "::= RuleUnopTerm '?'|RuleSequenceTerm ::= RuleUnopTerm|RuleUnopTerm ::="
    " SymbolReference|RuleUnopTerm ::= 'empty'|RuleUnopTerm ::= '(' RuleRhsL"
    "ist ReduceActions ')'|Rule ::= NonterminalReference '::^' SymbolReferen"
    "ce Rule:1|Rule:1 ::= Rule:1 PrecedenceSpec|Rule:1 ::= PrecedenceSpec|Pr"
    "ecedenceSpec ::= Assoc PrecedenceSpec:1|PrecedenceSpec:1 ::= Precedence"
    "Spec:1 Operator|PrecedenceSpec:1 ::= Operator|Assoc ::= '<<'|Assoc ::= "
    "'>>'|Operator ::= SymbolReference ReduceActions|SymbolReference ::= Ter"
    "minalReference|SymbolReference ::= NonterminalReference|TerminalReferen"
    "ce ::= TerminalSymbol|NonterminalReference ::= NonterminalSymbol|Reduce"
    "AstAction ::= AstFormer|ReduceAstAction ::= AstChild|ReduceAstAction ::"
    "= *epsilon*|AstFormer ::= '(' AstFormer:1 ')'|AstFormer:1 ::= AstFormer"
    ":2|AstFormer:2 ::= AstItem AstFormer:3|AstFormer:3 ::= AstFormer:3 AstF"
    "ormer:4|AstFormer:4 ::= AstFormer:5 AstItem|AstFormer:5 ::= ','|AstForm"
    "er:5 ::= *epsilon*|AstFormer:3 ::= *epsilon*|AstFormer:1 ::= *epsilon*|"
    "AstItem ::= AstChild|AstChild ::= '$' AstChildSpec '.' AstSliceSpec|Ast"
    "Child ::= '$' AstChildSpec|AstChild ::= '$' AstSliceSpec|AstItem ::= Id"
    "entifier|AstItem ::= '%' AstChildSpec|AstItem ::= '@' AstChildSpec|AstI"
    "tem ::= '@' StringValue|AstItem ::= '&' AstChildSpec|AstItem ::= '&' St"
    "ringValue|AstItem ::= AstFormer|AstChildSpec ::= AstChildNumber AstChil"
    "dSpec:1|AstChildSpec:1 ::= AstChildSpec:1 AstChildSpec:2|AstChildSpec:2"
    " ::= '.' AstChildNumber|AstChildSpec:1 ::= *epsilon*|AstSliceSpec ::= A"
    "stFirstChildNumber '_' AstLastChildNumber|AstFirstChildNumber ::= AstCh"
    "ildNumber|AstFirstChildNumber ::= *epsilon*|AstLastChildNumber ::= AstC"
    "hildNumber|AstLastChildNumber ::= *epsilon*|AstChildNumber ::= '-' <int"
    "eger>|AstChildNumber ::= <integer>|ReduceGuardAction ::= '[' ActionStat"
    "ementList ']'|ActionStatementList ::= ActionStatementList:1|ActionState"
    "mentList:1 ::= ActionStatementList:1 ActionStatement|ActionStatementLis"
    "t:1 ::= *epsilon*|ActionStatement ::= Identifier ':=' ActionExpression "
    "';'|ActionStatement ::= 'dump_stack' ';'|ActionExpression ::= ActionExp"
    "ression '{',' ActionExpression:1|ActionExpression ::= ActionExpression:"
    "1|ActionExpression:1 ::= ActionExpression:1 '&' ActionExpression:2|Acti"
    "onExpression:1 ::= ActionExpression:2|ActionExpression:2 ::= ActionExpr"
    "ession:2 '=' ActionExpression:3|ActionExpression:2 ::= ActionExpression"
    ":2 '/=' ActionExpression:3|ActionExpression:2 ::= ActionExpression:2 '<"
    "' ActionExpression:3|ActionExpression:2 ::= ActionExpression:2 '<=' Act"
    "ionExpression:3|ActionExpression:2 ::= ActionExpression:2 '>' ActionExp"
    "ression:3|ActionExpression:2 ::= ActionExpression:2 '>=' ActionExpressi"
    "on:3|ActionExpression:2 ::= ActionExpression:3|ActionExpression:3 ::= A"
    "ctionExpression:3 '+' ActionExpression:4|ActionExpression:3 ::= ActionE"
    "xpression:3 '-' ActionExpression:4|ActionExpression:3 ::= ActionExpress"
    "ion:4|ActionExpression:4 ::= ActionExpression:4 '*' ActionUnopExpressio"
    "n|ActionExpression:4 ::= ActionExpression:4 '/' ActionUnopExpression|Ac"
    "tionExpression:4 ::= ActionUnopExpression|ActionUnopExpression ::= '-' "
    "ActionUnopTerm|ActionUnopExpression ::= '!' ActionUnopTerm|ActionUnopEx"
    "pression ::= ActionUnopTerm|ActionUnopTerm ::= '(' ActionExpression ')'"
    "|ActionUnopTerm ::= IntegerValue|ActionUnopTerm ::= Identifier|ActionUn"
    "opTerm ::= 'token_count'|TerminalSymbol ::= <string>|TerminalSymbol ::="
    " <bracketstring>|NonterminalSymbol ::= <identifier>|IntegerValue ::= <i"
    "nteger>|BooleanValue ::= 'true'|BooleanValue ::= 'false'|StringValue ::"
    "= <string>|StringValue ::= <triplestring>|Identifier ::= <identifier>|}"
    "0|!~L&|!~)'|!~/'|5'|='|G'|M'|U'|]'|%(|-(|5(|=(|G(|M(|X(|')|1)|7)|?)|G)|"
    "V)|^)|(*|0*|:*|B*|J*|R*|Z*|\"+|*+|!~2+|8+|B+|J+|\\+|&,|2,|@,|J,|T,|Y,|_"
    ",|'-|1-|9-|C-|M-|!~!~W-|]-|+.|>.|H.|P.|_.|)/|1/|7/|=/|!~!~K/|S/|!~!~[/|"
    "!0|!~)0|30|=0|!~B0|H0|N0|!~T0|^0|*1|61|>1|F1|N1|V1|^1|!~&2|02|:2|?2|E2|"
    "!~O2|!~V2|]2|%3|-3|23|:3|D3|J3|V3|\\3|!~&4|!~04|:4|D4|N4|X4|\"5|!~,5|65"
    "|!~@5|J5|!~T5|\\5|!~$6|!~!~)6|/6|76|?6|G6|O6|U6|[6|#7|+7|}1|\"|}2||}3|?"
    "#|}4|>$|}5|U+|['|%7|L'|-*|](|#+|P.|8Z|>'|9#|P)|:/|[_|9'|F#|W#|Y#|:$|Y=|"
    "8*|/&|_&|M<|+.|U.|_*|S%|.&|>)|Q%|;%|K#|8)|ZF|28|)>|K%|; !|+ !|)!!|N7|76"
    "|(^|.^|+K|?J|$5|N$|6;|^]|JY|?X|)X|HG|UJ| %|#R|HR|R$|4C|U]|L]|FS|ZA|@%|G"
    "-|\\2|PF|4#|B\"|8[|;)|:)|*)|,*|))|#)|2(|*(|\\V|(S|;U|U_|H,|O3|[M|%'|A5|"
    "'^|=4|L/|]$|&,|P;|O(|J!|D+|J)|X%|]!|%0|0_|A_|V%|!)|&]|Z!!|X4|T5|& !|[;|"
    "'C|,O|R9|5&|9&|<-|<V|94|B?|XU|O2|*2|TV|-?|UT|8W|?L|+U|EW|P'|FY|TX|\\X|M"
    "1|OT| L|I'|=!!|$?|,!!|4^|2 !|_^|!5|Y:|B3|A;|Q@|_#|.A|4A|RA|7C|8$|1L|$S|"
    "3F|NF|QI|+G|?T|;\"|L@|Y\"|:=|':|4.|U7|2&|E'|4I|>M|BK|B&|SK|G(|]C|]R|V<|"
    "EX|9W|VY|1Z|7Z|#\\|9[|G\\|M\\|6@|LV|5$|W'|0%|$Y|! !|HI|S)|<6|XH|#:|[Q|4"
    "Q|YP|>P|#P|<O|XE|=E| E|*H|AC|7+|>O|5%|B0|RM|/-|X$|P>|R#|D:||V+|W)|45|-'"
    "|L4|F1|F$|4$|&(|?8|\"-|G[|H*|L1|X,|U4|L8|G+|P\"|P(|I1|TC|!T|PU|0B|,&|KB"
    "|I?|)N|>9|PD|*M|2@|HN|M6|G0|<&|#=|?Z|%/|%U|6Q|Y$|;2|#1|8?|E1|>7|?/|9R|["
    "1|^!|3*|\\3|0>|)1|C(|B#|YI|33|)T|^'|}6| $!|}7| 0 &'|!$ 0'|\"$ F'|#$ R|$"
    "$ .'|%4|&$ $'|'$ B'|($ 8'|)$ 6'|*$ ,\"|+$ *\"|,$ H\"|-$ @'|.$ 6|/$ 8#|0"
    "$ :#|1$ 4'|2$ <'|3$ 0%|4$ 2'|5$ :'|6$ D'|7$ H%|8$ P%|9$ L%|:$ R%|;$ N%|"
    "<$ 0\"|=$ 8\"|>$ 4\"|?$ >\"|@$ 2\"|A$ 6\"|B$ :\"|C$ <\"|D$ J!|E$ Z%|F$ "
    "\"%|G$  %|H$ .|I$  \"|J$ >'|K$ D|L$ >|M$ @|N$ F$|O$ B|P$ <|Q0 *'|R$ $&|"
    "S$ V#|T$ &!|U$ $!|V$ 2!|W$ 4!|X$ H&|Y$ ,&|Z$ (|[, &(|\\, ((|], V'|^, T'"
    "|_, P'| - N'|!- @(|\"- *(|#- N|$- L'|%- >(|&- N!|'- J'|(- Z'|)- X'|*- ^"
    "'|+- :(|,- F!|-- <(|.- H'|/- 6(|0- B!|1- $(|2- 0(|3- 8(|4- \\'|5-  (|6-"
    " R'|7- @\"|8- (%|9- 2(|:- F#|;- 0#|<- 2#|=- 0$|>- \"(|?- R!|@- .(|A- (\""
    "|B- D$|C- B(|D- 4(|E- 4$|F- $\"|G- X!|H- ,(|I-  $|J- T\"|K- &|L- 8%|M- "
    ",%|N- .%|O- <%|P- \"|Q- 2|R- 4|S- H|T- .\"|U- $|V- *|W- \"&|X- J\"|Y- 0"
    "|Z- :|[- ,|\\- 8|]- T| 0 &'|!0 0'|\"0 P|#0 R|$HS 04|%HS PW|&0 $'|'H$! L"
    "|(HS  9|)H$!PN|*HS @1|+HS 01|,HS  5|-H$!PK|.H$!P\"|/HS  ;|0HS 0;|1H$!@N"
    "|2H$!0M|3HS  J|4H$! O|5H$! V|J$ &$|7H$! M|8H$! N|9H$!@M|:H$!0N|;H$!PM|<"
    "H$! 2|=H$! 3|>H$!@2|?H$!P3|@H$!02|AH$!P2|BH$!03|CH$!@3| (@ P$|EH$!0O|\""
    "(@  &|#(@ 0&|HH$!P!|J$ .$|-$ ^%|KH$!@$|LH$!P#|MH$! $|NHS PD|OH$!0$|PH$!"
    "@#|QHS 0Y| 0 &'|!0 0'|\"0 P|#0 R|$0 B\"|%0 ^&|&0 $'|'H$! L|(0 (#|)H$!PN"
    "|*0 ,\"|+0 *\"|,0 H\"|-H$!PK|.H$!P\"|/0 8#|00 :#|1H$!@N|2H$!0M|30 0%|4H"
    "$! O|5H$! V|-$ &&|7H$! M|8H$! N|9H$!@M|:H$!0N|;H$!PM|<H$! 2|=H$! 3|>H$!"
    "@2|?H$!P3|@H$!02|AH$!P2|BH$!03|CH$!@3| H? P$|EH$!0O|\"H?  &|#H? 0&|HH$!"
    "P!| $ F|=- 0$|KH$!@$|LH$!P#|MH$! $|N0 F$|OH$!0$|PH$!@#|Q0 *'| 0 &'|!0 0"
    "'|\"0 P|#0 R|$(S 04|%(S PW|&0 $'|'H$! L|((S  9|)H$!PN|*(S @1|+(S 01|,(S"
    "  5|-H$!PK|.H$!P\"|/(S  ;|0(S 0;|1H$!@N|2H$!0M|3(S  J|4H$! O|5H$! V|2$ "
    "Z|7H$! M|8H$! N|9H$!@M|:H$!0N|;H$!PM|<H$! 2|=H$! 3|>H$!@2|?H$!P3|@H$!02"
    "|AH$!P2|BH$!03|CH$!@3|'$ @%|EH$!0O|6  \\&|2$ \\|HH$!P!|2$ ^|-$ >%|KH$!@"
    "$|LH$!P#|MH$! $|N(S PD|OH$!0$|PH$!@#|Q(S 0Y| $ &'|!HH 0B|\"$ P|#$ R|$$ "
    ".'|!HW  R|&$ <#|\"- L|#- N|)$ R$|&$ F%|'HW  L|,$ H\"|V$ 2!|W$ 4!|/$ 8#|"
    "0$ :#|-HW PK| 0 F|!(T @=|\"0 P|#0 R|6$ *!|%(T PW|2$  !|5HW  V| (7 P$|!("
    "7 @=|*(T @1|+(T 01| H3 P$|%(7 PW|.(/ P\"|'(7 @5|((7 @.|%H3 PW|D$ J!| 0 "
    "F|F$ \"%|G$  %|1- 8!|D- J|%0 ^&|\"$ P|#$ R|)  Z&|<(/  2|=(/  3|>(/ @2|?"
    "(/ P3|@(/ 02|A(/ P2|B(/ 03|C(/ @3|*$ ,\"|+$ *\"|S- H|X$ H&|6  X&|[, N(|"
    "\\, J$|], ^$|^, T$|_, \\$| - Z$|!- :!|\"- <!|#- N|$- X$|%- H!|&- N!|'- "
    "V$|'$ @%|)- .#|*- ,#|+- D!|,- F!|!(5 @=|.- B%|/- @!|0- B!|5$ J&|NHN 0D|"
    "3- \"\"|($ T!|5- 4#|5$ P&| H$!P$|!H$! R|\"H$! &|#H$!0&|;- 0#|<- 2#|&H$!"
    "PL|'H$! L| H( P$|)H$!PN|\"H(  &|#H( 0&|!$ 2$|-H$!PK|.H$!P\"|\"$ T#|($ ("
    "!|1H$!@N|2H$!0M|!- R#|4H$! O|5H$! V|.H( P\"|7H$! M|8H$! N|9H$!@M|:H$!0N"
    "|;H$!PM|<H$! 2|=H$! 3|>H$!@2|?H$!P3|@H$!02|AH$!P2|BH$!03|CH$!@3| (3 P$|"
    "EH$!0O|V$ 2!|W$ 4!|HH$!P!|%(3 PW|G- X!|KH$!@$|LH$!P#|MH$! $|-$ ,'|OH$!0"
    "$|PH$!@#| 0 F|!H!! R|\"H.  &|#H. 0&|@- &\"|A- (\"|&H!!PL|'H!! L|6$ *!|)"
    "H!!PN|F- $\"|V$ 2!|W$ 4!|-H!!PK|.0 6|S$ V#|1- 6!|1H!!@N|2H!!0M|6$ H$|4H"
    "!! O|5H!! V|2- N\"|7H!! M|8H!! N|9H!!@M|:H!!0N|;H!!PM|<H.  2|=H.  3|>H."
    " @2|?H. P3|@H. 02|AH. P2|BH. 03|CH. @3|N(Q PD|EH!!0O|1- 0!|N$ F$|H0 .|-"
    "- ,$|!$ L#|K0 D|L0 >|M0 @|\\, ,!|O0 B|P0 <| 0 &'|!0 0'|\"($! &|#($!0&|$"
    "0 H(|%($!PW|&('!@X|'0 B'|(($!@.|)('!PN|*($!@1|+($!01|,('! 5|-('!PK|Y$ ,"
    "&|/('! ;|0('!0;|10 4'|2('!0M|3('! J|40 2'|5('! V|%H  PW|7('! M|8('! N|9"
    "('!@M|:('!0N|;('!PM| HG 09|!HE 0B|2$ X| (! P$|$HG 04|)$ H#|&HG @;| HU 0"
    "9|D($!0-|E('!0O|T$ &!|U$ $!|,HG  5|I($! 0| (U 09|/HG  ;|0HG 0;|.(! P\"|"
    "6$ >#|3$ 0%|-HU @Y| H3 P$|!$ L#|%4|T($!P(|U($!@(|%H3 PW|-(U @Y|X('! U| "
    "0 &'|!0 0'|\"0 P|#0 R|$0 H(|%0 ^&|&0 $'|'0 B'|(0 J(|)(!!PN|*HD @1|+HD 0"
    "1|,HD  5|-(!!PK|H(! P!|/HD  ;|0HD 0;|10 4'|2(!!0M|3HD  J|40 2'|5(!! V|2"
    "$ &#|7(!! M|8(!! N|9(!!@M|:(!!0N|;(!!PM|RHU @P| $ &'|2$ $#|\"$ P|#$ R|$"
    "$ P(|!$ 0&|R(U @P|D(< 0-|E(!!0O|)$ R$|(- *&|'$ @%|I(<  0| 0 &'|!0 ('|\""
    "0 P|#0 R|$0 H(|%(#!PW|&(&!@;|'(#!@5|((#! X|6$ *!|*(#!@1|+(#!01|,(&! 5| "
    "(2 P$|.0 6|/(&! ;|0(&!0;|1(#!P/|!(E 0B|3(&! J|4(#!@/|6$ *!|6- &%|D$ J!|"
    "8- (%|F$ \"%|G$  %|.$ 6|<0 0\"|=0 8\"|>0 4\"|?0 >\"|@0 2\"|A0 6\"|B0 :\""
    "|C0 <\"|D(#!0-|2$ \"#|M- ,%|N- .%| H2 P$|I(#! 0|J(&!0?|2$  #|2$ \\\"|%H"
    "2 PW|[, P$|\\, J$|], ^$|^, T$|_, \\$| - Z$|!- :!|\"- <!|#- N|$- X$|%- H"
    "!|&- N!|'- V$|\\, $$|2$ Z\"|2$ X\"|+- D!|,- F!| H1 P$|.- B%|/- @!|0- B!"
    "|6$ *!|\"$ T#|3- \"\"| HD PX|!0 0'|\"HD  &|#HD 0&|$HD 04|%HD PW|&0 $'|'"
    "(!! L|(HD  9|)(!!PN|*HD @1|+HD 01|,HD  5|-(!!PK|!~/HD  ;|0HD 0;|1(!!@N|"
    "2(!!0M|3HD  J|4(!! O|5(!! V| ($ P$|7(!! M|8(!! N|9(!!@M|:(!!0N|;(!!PM| "
    "$ &'|!HH 0B|\"$ P|#$ R|$$ H(| $ F|&$ <#|\\, .!|.($ P\"|E(!!0O|%(1 PW|2$"
    " ^\"|,$ H\"|V$ 2!|W$ 4!|/$ 8#|0$ :#|!~!~S$ V#|!~ 0 F|!(D @=|\"0 P|#0 R|"
    "$$ B\"|%(D PW|Q- 2|R- 4|((D  9|!~*(D @1|+(D 01|,$ H\"|H($ P!|.(* P\"|D$"
    " J!|K($ @$|L($ P#|M($  $|1- *$|O($ 0$|P($ @#|!~ H' P$|-- \\#|\"H'  &|#H"
    "' 0&| (\" P$|<(*  2|=(*  3|>(* @2|?(* P3|@(* 02|A(* P2|B(* 03|C(* @3|9-"
    " L&|.H' P\"|[, 6#|!~!~.(\" P\"|J$ .$|!~!- :!|\"- <!|#- N| HV 09|%- H!|&"
    "- N!|\"- L|#- N|)- .#|*- ,#|+- D!|,- F!|!~!~/- @!|0- B!|-HV @Y|!~3- \"\""
    "| $ &'|5- 4#|\"$ P|#$ R|$$ P(|!~!~;- 0#|<- 2#|)$ R$|)- F\"|*- D\"|!~!~ "
    "H! P$| 0 F|!(D @=|\"0 P|#0 R|$$ B\"|%(D PW|D- \"!|6$ *!|((D  9|7- @\"|*"
    "(D @1|+(D 01|,$ H\"|.H! P\"|.(* P\"|=- 0$|Y- 0|?- R!|\"$ T#|RHV @P|!~D$"
    " J!|!~F$ \"%|G$  %|!~!~!~<(*  2|=(*  3|>(* @2|?(* P3|@(* 02|A(* P2|B(* "
    "03|C(* @3|V$ 2!|W$ 4!|!~HH! P!|!~!~!~!~[, P$|\\, J$|], ^$|^, T$|_, \\$|"
    " - Z$|!- :!|\"- <!|#- N|$- X$|%- H!|&- N!|'- .&|Z$ (|!~)$ H#|+- D!|,- F"
    "!|!~1- ($|/- J#|0- B!| $ *#|S$ V#|\"$ F'|#$ R|$$ N$|!~6$ >#|)- F\"|*- D"
    "\"|)$ R$| 0 &'|!H9 @=|\"H9  &|#H9 0&|$0 P(|%H9 PW|!~'H9 @5|(H9 @.|)$ R$"
    "|!~7- @\"|6$ *!| $ F|!~\"$ F|#$ F|-- X#|%$ F|?- R!|NHQ PD|($ F|6$ *!|*$"
    " F|+$ F|!~ H6 P$|!H6 @=|F$ \"%|G$  %|K- &|%H6 PW|J$ V(|'H6 @5|(H6 @.|P-"
    " \"|DH9 0-| H< P$|F$ \"%|G$  %|U- $|S$ V#|%H< PW|!~V$ 2!|W$ 4!|(- D#|*$"
    " ,\"|+$ *\"|[, P$|\\, ((|], ^$|^, T$|_, \\$| - 6&|!- R#|!~!~4- @#|[, P$"
    "|\\, J$|], ^$|^, T$|_, @&|:- F#|T(> P$|U(> P$|-- X(|>- B#|!~!~1- $(|!~ "
    "(#!P$|!(#!@=|\"(#! &|#(#!0&|$(#!@-|%(#!PW|9- ^#|'(#!@5|((#! X| (G 09|*("
    "#!@1|+(#!01|!~$(G 04|.(#!P\"|&(G @;|C- \"$|1(#!P/|!~!~4(#!@/|,(G  5|I- "
    " $|!~/(G  ;|0(G 0;|!~!~<(#! 2|=(#! 3|>(#!@2|?(#!P3|@(#!02|A(#!P2|B(#!03"
    "|C(#!@3|D(#!0-| (( P$|!~\"((  &|#(( 0&|I(#! 0| H#!P$|!H#!@=|\"H#! &|#H#"
    "!0&|$H#!@-|%H#!PW|!~'H#!@5|(H#! X|.(( P\"|*H#!@1|+H#!01|!~!~.H#!P\"|!~ "
    "0 F|1H#!P/|@- P\"|A- (\"|4H#!@/|%0 ^&|!~!~!~!~*0 ,\"|+0 *\"|<H#! 2|=H#!"
    " 3|>H#!@2|?H#!P3|@H#!02|AH#!P2|BH#!03|CH#!@3|DH#!0-| (' P$|!~\"$ P|#$ R"
    "|IH#! 0| 0 F|!(B @=|\"0 P|#0 R|$(B @-|%(B PW|!~'(B @5|(0  '|.(' P\"|*(B"
    " @1|+(B 01|!~ (? P$|.0 6|\"(?  &|#(? 0&|1(B P/|%(? PW|!~4(B @/|!~!~*(? "
    "@1|+(? 01|!~!~!~<H*  2|=H*  3|>H* @2|?H* P3|@H* 02|AH* P2|BH* 03|CH* @3"
    "|D(B 0-|!~ ('!09|!('!0X|!~I(B  0|$('!04|!~&('!@X|'('! L|!~)('!PN|!~!~,("
    "'! 5|-('!PK|!~/('! ;|0('!0;|1('!@N|2('!0M|3('! J|4('! O|5('! V|!- V|7('"
    "! M|8('! N|9('!@M|:('!0N|;('!PM|!~ (V 09|!~!~!~!~ (K 09|!0 \"'|!~E('!0O"
    "|$(K 04|\\- 8|&0 $'|'(\"! L|-(V @Y|)(\"!PN|!~!~,(K  5|-(\"!PK|!~/(K  ;|"
    "0(K 0;|1(\"!@N|2(\"!0M|3(K  J|4(\"! O|5(\"! V|X('! U|7(\"! M|8(\"! N|9("
    "\"!@M|:(\"!0N|;(\"!PM| (5 P$|!(5 @=|!~!~!~%(5 PW| (K 09|!0 \"'|($ T!|E("
    "\"!0O|$(K 04|!~&0 $'|'(\"! L|!~)(\"!PN|!~R(V @P|,(K  5|-(\"!PK|]- T|/(K"
    "  ;|0(K 0;|1(\"!@N|2(\"!0M|3(K  J|4(\"! O|5(\"! V|X$ H&|7(\"! M|8(\"! N"
    "|9(\"!@M|:(\"!0N|;(\"!PM| 0 &'|!0 2$|\"0 P|#0 R|$0 B\"|!$ 0&|&0 <#| 0 *"
    "#| HU 09|E(\"!0O|)$ H#|'$ @%|,0 H\"|!~.0 6|/0 8#|00 :#|-$ >%|!~30 0%|-0"
    " ,'|-HU @Y| $ *#|6$ >#|!~5$ P&|$$ N$|!~<0 0\"|=0 8\"|>0 4\"|?0 >\"|@0 2"
    "\"|A0 6\"|B0 :\"|C0 <\"|!~ H&!PX|!H&!0B|\"H&! &|#H&!0&|$H&!04|J(. 0?|&H"
    "&!@;|6$ R(|!~!~NHQ PD|2- Z(|,H&! 5|!~.H&!P\"|/H&! ;|0H&!0;| 0 F|!0 L#|3"
    "H&! J|R0 $&|RHU @P|%0 ^&|F$ \"%|'0 L\"|(0 T!|!~!~<H&! 2|=H&! 3|>H&!@2|?"
    "H&!P3|@H&!02|AH&!P2|BH&!03|CH&!@3|(- L(| (&!PX|!(&!0B|\"(&! &|#(&!0&|$("
    "&!04|JH&!0?|&(&!@;|[, P$|\\, J$|], D%|!~!~,(&! 5| H= P$|.(&!P\"|/(&! ;|"
    "0(&!0;|:- F#|%H= PW|3(&! J|6- *%|>- 2%|8- (%|*H= @1|+H= 01|!~!~!~<(&! 2"
    "|=(&! 3|>(&!@2|?(&!P3|@(&!02|A(&!P2|B(&!03|C(&!@3| 0 *#|!~!~!~$$ N$|!~J"
    "(&!0?|!~!~)$ R$|!~!~!~-HU @Y|!~ HR PX|!HR  Y|\"HR  &|#HR 0&|$HR 04|%HR "
    "PW|&HR @;|6$ *!|(HR  9|)$ H#|*HR @1|+HR 01|,HR  5| (6 P$|!(6 @=|/HR  ;|"
    "0HR 0;|!~%(6 PW|3HR  J|'(6 @5|((6 @.|6$ >#|F$ \"%|G$  %|!~ (D P$|!(D @="
    "|\"(D  &|#(D 0&|$$ B\"|%(D PW|G- X!|!~((D  9|RHU @P|*(D @1|+(D 01|,$ H\""
    "|!~!~!~!~!~[, P$|\\, J$|], ^$|^, T$|_, \\$| - Z$|!~!~!~$- X$|!~ H@ P$|'"
    "- V$|\"H@  &|#H@ 0&|   T&|%H@ PW|\"$ P|#$ R|.- L$|%(> PW|*H@ @1|+H@ 01|"
    "!~J$ .$|*(> @1|+(> 01|6- &%|(- :%|8- (%| 0 &'|!0 ('|\"0 P|#0 R|$0 H(|%0"
    " ^&|&HD @;|'(< @5|(0 J(| 0 *#|*HD @1|+HD 01|,HD  5|$$ N$|!~/HD  ;|0HD 0"
    ";|1(< P/|)$ R$|3HD  J|4(< @/|)$ H#|-HU @Y|!~ (5 P$|)- F\"|*- D\"|!~!~%("
    "5 PW|)$ H#|6$ *!|($ T!|!~6$ >#|!~D(< 0-|O- <%|!~7- @\"| $ *#|I(<  0|\"$"
    " T#|6$ >#|$$ N$|=- 0$|!~F$ \"%|G$  %|)$ D(|!- :!|\"- <!|#- N| (= P$|%- "
    "R\"|&- N!|!~!~%(= PW|RHU @P|!~!~6$ F(|*(= @1|+(= 01|!~!~NHQ PD|[, P$|\\"
    ", J$|], ^$|^, T$|_, \\$| - Z$|\"$ T#|!~!~$- X$|F$ \"%|G$  %|'- V$|)$ H#"
    "|!~!~(- 8$|!~!~.- L$|!~H- P#|!~S$ V#|!~(- 4%|6$ >#|6- R'|4- 6$|8- (%|!~"
    "[, P$|\\, J$|], ^$|^, T$|_, \\$| - Z$|!~2- V!| H%!P$|$- 2&|\"H%! &|#H%!"
    "0&|:- F#|(- 8$|!(W  R|!~>- 2%|!~-- >$|&$ F%|'(W  L|!~.H%!P\"|!~S$ V#|4-"
    " @$|-(W PK|!~!~!~ 0 F|!~\"0 P|#0 R|5(W  V|!~<H%! 2|=H%! 3|>H%!@2|?H%!P3"
    "|@H%!02|AH%!P2|BH%!03|CH%!@3|.0 6|(- 8$|!~!~HH%!P!|!~-- :$|KH%!@$|LH%!P"
    "#|MH%! $| H\" P$|OH%!0$|PH%!@#|4- <$|<0 0\"|=0 8\"|>0 4\"|?0 >\"|@0 2\""
    "|A0 6\"|B0 :\"|C0 <\"|!~!~.H\" P\"|!~H0 .|!~!~K0 D|L0 >|M0 @|!~O0 B|P0 "
    "<| 0 F|!(; @=|\"0 P|#0 R|$(; @-|%0 ^&|!~'(; @5|(0 T!|!~*0 ,\"|+0 *\"|!~"
    "!~!~H$ .| (%!P$|1(; P/|\"(%! &|#(%!0&|4(; @/|!~!~ HI PX|!HI  Y|\"HI  &|"
    "#HI 0&|$HI 04|%HI PW|&HI @;|.(%!P\"|(HI  9|!~*HI @1|+HI 01|,HI  5|D(; 0"
    "-|!~/HI  ;|0HI 0;|!~I(;  0|3HI  J|!~<(%! 2|=(%! 3|>(%!@2|?(%!P3|@(%!02|"
    "A(%!P2|B(%!03|C(%!@3| $ F|!~\"$ P|#$ R|H(%!P!|!~!~K(%!@$|L(%!P#|M(%! $|"
    "!~O(%!0$|P(%!@#| 0 &'|!(9 @=|\"(9  &|#(9 0&|$0 P(|%(9 PW|!~'(9 @5|((9 @"
    ".|)$ R$|!~!~!~ 0 F|!(T @=|\"0 P|#0 R|2- N#|%(T PW|!~!~!~6$ *!|*(T @1|+("
    "T 01|!~!~.(/ P\"|V- *|!~!~@- &\"|A- (\"|[- ,|!~!~D(9 0-|F- $\"|F$ \"%|G"
    "$  %|!~<(/  2|=(/  3|>(/ @2|?(/ P3|@(/ 02|A(/ P2|B(/ 03|C(/ @3|!~!~!~!-"
    " :!|\"- <!|#- N|!~%- P!|&- N!|!~[, P$|\\, J$|], ^$|^, D&| 0 &'|!0 ('|\""
    "0 P|#0 R|$0 B\"|%0 ^&|&0 <#|Y$ ,&|(0 (#|!~*0 ,\"|+0 *\"|,0 H\"|!~!~/0 8"
    "#|00 :#|!~!~30 0%| (P PX|!(P  Y|\"(P  &|#(P 0&|$(P 04|%(P PW|&(P @;|!~("
    "(P  9|!~*(P @1|+(P 01|,(P  5|!~!~/(P  ;|0(P 0;|!~!(X  R|3(P  J|!~ $ *#|"
    "!~&(X PL|'(X  L|$$ B\"|N(Q PD|&$ <#|!~Q0 *'|-(X PK|!~!~,$ H\"|!~2$ J%|/"
    "$ 8#|0$ :#|5(X  V|!~7$ H%|8$ P%|9$ L%|:$ R%|;$ N%|!~N(Q PD|!~!~Q(P 0Y| "
    "$ 6%|!$ 6%|\"$ 6%|#$ 6%|$$ 6%|%$ 6%|&$ 6%|!~($ 6%|!~*$ 6%|+$ 6%|,$ 6%|!"
    "~!~/$ 6%|0$ 6%|!~!~3$ 6%|!~ HN PX|!HN  Y|\"HN  &|#HN 0&|$HN 04|%HN PW|&"
    "HN @;|B- D$|(HN  9|[, 6#|*HN @1|+HN 01|,HN  5|!~!~/HN  ;|0HN 0;|!~!~3HN"
    "  J|!~!~!~)- .#|*- ,#|NHN 0D|!~B- D$|Q$ 6%|   R&|!H7 @=|\"$ P|#$ R|$$ L"
    "!|%H7 PW|5- (&|'H7 @5|(H7 @.|!~!~ (S PX|!(S  Y|\"(S  &|#(S 0&|$(S 04|%("
    "S PW|&(S @;|!~((S  9|Q  V&|*(S @1|+(S 01|,(S  5|!~!~/(S  ;|0(S 0;|\"$ T"
    "#|!~3(S  J|!~!~!~!~!~D$ J!| HS PX|!HS  Y|\"HS  &|#HS 0&|$HS 04|%HS PW|&"
    "HS @;|!~(HS  9|!~*HS @1|+HS 01|,HS  5|!~!~/HS  ;|0HS 0;|!~!~3HS  J|N(S "
    "PD|!~!~Q(S 0Y|!~!~!~!~!- :!|\"- <!|#- N|J$ Z#|%- H!|&- N!|!~!~!~!~+- Z!"
    "|,- F!|S$ V#|!~L- 8%|!~!~!~NHS PD|!~!~QHS 0Y| HB P$|!HB @=|\"HB  &|#HB "
    "0&|$HB @-|%HB PW|!~'HB @5|(HB @.| $ *#|*HB @1|+HB 01|!~$$ N$|!~!~-- \\#"
    "|1HB P/|)$ R$|!~4HB @/|!~ HA P$|!HA @=|\"HA  &|#HA 0&|$HA @-|%HA PW|9- "
    "^#|'HA @5|(HA @.|6$ *!|*HA @1|+HA 01|!~!~DHB 0-|!~C- \"$|1HA P/|!~IHB  "
    "0|4HA @/|!~I-  $| (F 09|!(F 0B|F$ \"%|G$  %|$(F 04|!~&(F @;|THB P(|UHB "
    "@(|!~!~!~,(F  5|DHA 0-|!~/(F  ;|0(F 0;|!~IHA  0|3(F  J|!~!~!~[, P$|\\, "
    "J$|], ^$|^, T$|_, \\$| - 4&|T$ &!|U$ $!| ($!P$|!($!@=|\"($! &|#($!0&|$("
    "$!@-|%($!PW|!~'($!@5|(($!@.|!~*($!@1|+($!01|!~!~!~!~ (* P$|1($!P/|\"(* "
    " &|#(* 0&|4($!@/|!~!~ HO PX|!HO  Y|\"HO  &|#HO 0&|$HO 04|%HO PW|&HO @;|"
    ".(* P\"|(HO  9|!~*HO @1|+HO 01|,HO  5|D($!0-|!~/HO  ;|0HO 0;|!~I($! 0|3"
    "HO  J|!~<(*  2|=(*  3|>(* @2|?(* P3|@(* 02|A(* P2|B(* 03|C(* @3|T($!P(|"
    "U($!@(|!~ $ 6%|!$ 6%|\"$ 6%|#$ 6%|$$ 6%|%$ 6%|&$ 6%|!~($ 6%|!~*$ 6%|+$ "
    "6%|,$ 6%|!~N(Q PD|/$ 6%|0$ 6%|QHO 0Y|!~3$ 6%| (P PX|!(P  Y|\"(P  &|#(P "
    "0&|$(P 04|%(P PW|&(P @;|!~((P  9| $ *#|*(P @1|+(P 01|,(P  5|$$ N$|!~/(P"
    "  ;|0(P 0;|!~)$ R$|3(P  J| 0 F|!0 L#|\"0 P|#0 R|$0 L!|%0 ^&|NHN 0D|'0 L"
    "\"|(0 T!|Q$ 6%| H> P$|6$ *!|\"H>  &|#H> 0&|!~%H> PW|?- R!|!~!0 0&|!~*H>"
    " @1|+H> 01|!~&0 F%|'0 @%|!~)0 V%|F$ \"%|G$  %|Q(P 0Y|-0 >%|!~!~!~10 T%|"
    "20 J%|D0 J!|40 X%|50 P&|!~70 H%|80 P%|90 L%|:0 R%|;0 N%|!~!~!~[, P$|\\,"
    " J$|], ^$|^, T$|_, \\$| - Z$|E0 Z%|!~!~$- X$| 0 *#|!0 2$|'- V$|!~$0 B\""
    "|!( ! R|&0 <#|!~!~.- L$|&( !PL|'( ! L|,0 H\"|)( !PN|!~/0 8#|00 :#|-( !P"
    "K|!~30 0%|B- D$|1( !@N|2( !0M|!~4( ! O|5( ! V| $ *#|7( ! M|8( ! N|9( !@"
    "M|:( !0N|;( !PM|!H!! R|!~!~!~!~&H!!PL|'H!! L|-HT @Y|)H!!PN|E( !0O|!~!~-"
    "H!!PK|!~!~!~1H!!@N|2H!!0M|!~4H!! O|5H!! V|!~7H!! M|8H!! N|9H!!@M|:H!!0N"
    "|;H!!PM|!~ $ *#|!~!~!~$$ N$|!~!~!(\"! R|EH!!0O|)$ R$|!~!~&(\"!PL|'(\"! "
    "L|!~)(\"!PN|R$ $&|!~!~-(\"!PK|!~!~6$ *!|1(\"!@N|2(\"!0M|[,  &|4(\"! O|5"
    "(\"! V|!~7(\"! M|8(\"! N|9(\"!@M|:(\"!0N|;(\"!PM|!~!~ $ *#|!~F$ \"%|G$ "
    " %|$$ N$|E- 4$|!~E(\"!0O| (: P$|!(: @=|\"(:  &|#(: 0&|$(: @-|%(: PW|!~'"
    "(: @5|((: @.|!~!~!~!~!~6$ *!|[, P$|\\, J$|], ^$|^, T$|_, \\$| - Z$|!~!~"
    "!0 0&|$- X$|!~!~'- V$|&0 F%|'0 @%|F$ \"%|)0 V%|!~!~.- B%|-0 >%|D(: 0-|!"
    "~!~10 T%|20 J%|W- \"&|4$ X%|50 P&|!~70 H%|80 P%|90 L%|:0 R%|;0 N%|!0 0&"
    "|[, P$|\\, J$|], D%|!~&0 F%|'0 @%|!~)0 V%|E$ Z%|!~!~-0 >%|!~!~!~10 T%|2"
    "0 J%|!~40 X%|50 P&|!~70 H%|80 P%|90 L%|:0 R%|;0 N%| (J PX|!(J  Y|\"(J  "
    "&|#(J 0&|$(J 04|%(J PW|&(J @;|!~((J  9|E0 Z%|*(J @1|+(J 01|,(J  5| H5 P"
    "$|!H5 @=|/(J  ;|0(J 0;|!(_  R|%H5 PW|3(J  J|'$ L\"|(H5 @.|&(_ PL|'(_  L"
    "|!~)(_ PN| $ *#|!~!~-(_ PK|$$ N$|!~!~1(_ @N|2(_ 0M|)$ R$|4(_  O|5(_  V|"
    "!~7(_  M|8(_  N|9(_ @M|:(_ 0N|;(_ PM|!~!~!0 0&|!~6$ *!|Q$ B$|!~&$ F%|'0"
    " @%|E(_ 0O|!~!H_  R|!~!~-0 >%|!~&H_ PL|'H_  L|!~)H_ PN|F$ \"%|G$  %|50 "
    "P&|-H_ PK|!~!~!~1H_ @N|2H_ 0M|!~4H_  O|5H_  V|!~7H_  M|8H_  N|9H_ @M|:H"
    "_ 0N|;H_ PM|!~!~!~[, P$|\\, J$|], ^$|^, T$|_, \\$| - Z$|EH_ 0O|!~!~$- X"
    "$|!~!~'- V$|!~!~!~!~!~!~.- N&| 0 &'|!0 ('|\"(J  &|#(J 0&|$0 B\"|%(J PW|"
    "&0 <#|!~((J  9|!~*(J @1|+(J 01|,0 H\"|!~!~/0 8#|00 :#|!(^  R|!~30 0%|!~"
    "!~&(^ PL|'(^  L|!~)(^ PN|!~!~X- J\"|-(^ PK|!~!~!~1(^ @N|2(^ 0M|!~4(^  O"
    "|5(^  V|!~7(^  M|8(^  N|9(^ @M|:(^ 0N|;(^ PM|!~!~!(]  R|!~!~Q$ B$|!~&(]"
    " PL|'(]  L|E(^ 0O|)(] PN|!~!~!~-(] PK|!~!~!~1(] @N|2(] 0M|!~4$ X%|5(]  "
    "V|!~7(]  M|8(]  N|9(] @M|:(] 0N|;(] PM|!H\\  R|!~!~!~!~&H\\ PL|'H\\  L|"
    "!~)H\\ PN|E$ Z%|!~!~-H\\ PK|!~!~!~1H\\ @N|2H\\ 0M|!~4$ X%|5H\\  V|!~7H\\"
    "  M|8H\\  N|9H\\ @M|:H\\ 0N|;H\\ PM|!H]  R|!~!~!~!~&H] PL|'H]  L|!~)H] "
    "PN|E$ Z%|!~!~-H] PK|!~!~!~1H] @N|2H] 0M|!~4$ X%|5H]  V|!~7H]  M|8H]  N|"
    "9H] @M|:H] 0N|;H] PM|!H ! R| $ F|!~\"$ P|#$ R|&H !PL|'H ! L|!~)H !PN|E$"
    " Z%|!~ $ F|-H !PK|\"$ P|#$ R|$$ L!|1H !@N|2H !0M|!~4H ! O|5H ! V|!~7H !"
    " M|8H ! N|9H !@M|:H !0N|;H !PM|!~!~!H\"! R|!~!~!~!~&H\"!PL|'H\"! L|EH !"
    "0O|)H\"!PN|!~!~!~-H\"!PK|!~!~!~1H\"!@N|2H\"!0M|D$ J!|4H\"! O|5H\"! V|!~"
    "7H\"! M|8H\"! N|9H\"!@M|:H\"!0N|;H\"!PM|!~ $ F|!~\"$ P|#$ R|$$ L!|!~!~!"
    "~EH\"!0O|!- :!|\"- <!|#- N|!~%- R\"|&- N!|!~!~!~!~!- :!|\"- <!|#- N|!~%"
    "- H!|&- N!|!~!~!~!~+- D!|,- F!|!~!~/- @!|0- B!|!H^  R|D$ J!|3- >!|!~!~&"
    "H^ PL|'H^  L|!~)H^ PN|!~!~!~-H^ PK|H- V\"|!~J- T\"|1H^ @N|2H^ 0M|!~4H^ "
    " O|5H^  V|!~7H^  M|8H^  N|9H^ @M|:H^ 0N|;H^ PM|!~!~!~!- :!|\"- <!|#- N|"
    "!~%- H!|&- N!|EH^ 0O|!~!~!~+- D!|,- F!|!~!~/- @!|0- B!|!(!! R|!~3- \"\""
    "|!~!~&(!!PL|'(!! L|!~)(!!PN|!~!~!~-(!!PK|!~!~!~1(!!@N|2(!!0M|!~4(!! O|5"
    "(!! V|!~7(!! M|8(!! N|9(!!@M|:(!!0N|;(!!PM| (O PX|!(O  Y|\"(O  &|#(O 0&"
    "|$(O 04|%(O PW|&(O @;|!~((O  9|E(!!0O|*(O @1|+(O 01|,(O  5|!~!~/(O  ;|0"
    "(O 0;|!~!~3(O  J| HO PX|!HO  Y|\"HO  &|#HO 0&|$HO 04|%HO PW|&HO @;|!~(H"
    "O  9| $ *#|*HO @1|+HO 01|,HO  5|$$ N$|!~/HO  ;|0HO 0;|!~!0 0&|3HO  J|!~"
    "!~!~&0 F%|'0 @%|!~)0 V%|!~!~Q(O 0Y|-0 >%|6$ *!|!~!~10 T%|20 J%|!~40 X%|"
    "50 P&|!~70 H%|80 P%|90 L%|:0 R%|;0 N%|!~!~F$ \"%|!~QHO 0Y|!~!~!~!~E0 Z%"
    "| HA P$|!HA @=|\"HA  &|#HA 0&|$HA @-|%HA PW|!~'HA @5|(HA @.|!~*HA @1|+H"
    "A 01|!~[, P$|\\, J$|], \\%|!~1HA P/|!~!~4HA @/|!~ (A P$|!(A @=|\"(A  &|"
    "#(A 0&|$(A @-|%(A PW|!~'(A @5|((A @.|!~*(A @1|+(A 01|!~!~DHA 0-|!~!~1(A"
    " P/|!~IHA  0|4(A @/|!~ (B P$|!(B @=|\"(B  &|#(B 0&|$(B @-|%(B PW|!~'(B "
    "@5|((B @.|!~*(B @1|+(B 01|!~!~D(A 0-|!~!~1(B P/|!~I(A  0|4(B @/|!~!~ HP"
    " PX|!HP  Y|\"HP  &|#HP 0&|$HP 04|%HP PW|&HP @;|!~(HP  9|!~*HP @1|+HP 01"
    "|,HP  5|D(B 0-|!~/HP  ;|0HP 0;| $ *#|I(B  0|3HP  J|!~$$ N$|!~!~!~!~)$ R"
    "$|!~!~!~ HD PX|!HD  Y|\"HD  &|#HD 0&|$HD 04|%HD PW|&HD @;|!~(HD  9|6$ *"
    "!|*HD @1|+HD 01|,HD  5|!~!~/HD  ;|0HD 0;|!~!HX  R|3HD  J|!~!~!~&HX PL|'"
    "HX  L|F$ \"%|G$  %|!~!~!~-HX PK| (, P$|!~\"(,  &|#(, 0&|2$ J%|!~!~5HX  "
    "V|!~7$ H%|8$ P%|9$ L%|:$ R%|;$ N%|.(, P\"|[, P$|\\, J$|], ^$|^, T$|_, \\"
    "$| - Z$|!~!~!~$- X$|!~!~'- .&|<(,  2|=(,  3|>(, @2|?(, P3|@(, 02|A(, P2"
    "|B(, 03|C(, @3|!~!~!~!~!~!~J$ Z#| 0 &'|!0 ('|\"(C  &|#(C 0&|$(N 04|%(C "
    "PW|&(N @;|!~((C  9|!~*(C @1|+(C 01|,(N  5|!~!~/(N  ;|0(N 0;|!~!~3(N  J|"
    " (R PX|!(R  Y|\"(R  &|#(R 0&|$(R 04|%(R PW|&(R @;|!~((R  9|!~*(R @1|+(R"
    " 01|,(R  5|!~!~/(R  ;|0(R 0;|!~!~3(R  J| $ F|!$ F|\"$ F|#$ F|$$ F|%$ F|"
    "!~'$ F|($ F| $ F|!~\"$ P|#$ R|$$ L!|!~!~C- $%|1$ F|!~!~4$ F|!~!~ 0 &'|!"
    "0 ('|\"HC  &|#HC 0&|$(I 04|%HC PW|&(I @;|!~(HC  9|!~*HC @1|+HC 01|,(I  "
    "5|D$ F|!~/(I  ;|0(I 0;|!~I$ F|3(I  J|!~!~D$ J!|!~!~!~!~!~!~TH7 P$|UH7 P"
    "$| 0 &'|!0 ('|\"0 P|#0 R|$0 B\"|%0 ^&|&0 <#|!~(0 (#|!~*0 ,\"|+0 *\"|,0 "
    "H\"|!~!~/0 8#|00 :#|!~!~30 0%|!- :!|\"- <!|#- N|!~%- H!|&- N!|!~!~!~!~+"
    "- D!|,- F!|!~!~/- J#|0- B!| HJ PX|!HJ  Y|\"HJ  &|#HJ 0&|$HJ 04|%HJ PW|&"
    "HJ @;|!~(HJ  9|!~*HJ @1|+HJ 01|,HJ  5|!~!~/HJ  ;|0HJ 0;|!H[  R| H- P$|3"
    "HJ  J|\"H-  &|#H- 0&|&H[ PL|'H[  L|!~)$ V%|!~!~!~-H[ PK|!~!~.H- P\"|1$ "
    "T%|2H[ 0M|!~!~5H[  V|!~7H[  M|8H[  N|9H[ @M|:H[ 0N|;H[ PM|!~!~<H-  2|=H"
    "-  3|>H- @2|?H- P3|@H- 02|AH- P2|BH- 03|CH- @3|!~!~!([  R|!~!~!~JH- 0?|"
    "&([ PL|'([  L|!~)$ V%|!~!~!~-([ PK|!~!~!~1$ T%|2([ 0M|!~!~5([  V|!~7([ "
    " M|8([  N|9([ @M|:([ 0N|;([ PM|!HZ  R|!~!~!~!~&HZ PL|'HZ  L|!~)$ V%|!~!"
    "~!~-HZ PK|!~!~!~1$ T%|2HZ 0M|!~!~5HZ  V|!~7HZ  M|8HZ  N|9HZ @M|:HZ 0N|;"
    "HZ PM|!HY  R|!~!~!~!~&HY PL|'HY  L|!~)$ V%|!~!~!~-HY PK|!~!~!~1$ T%|2HY"
    " 0M|!~!~5HY  V|!~7HY  M|8HY  N|9HY @M|:HY 0N|;HY PM|!(Y  R| 0 F|!~\"0 P"
    "|#0 R|&(Y PL|'(Y  L|!~)$ V%|!~!~!~-(Y PK|!~!~.0 6|1$ T%|2(Y 0M|!~!~5(Y "
    " V|!~7(Y  M|8(Y  N|9(Y @M|:(Y 0N|;(Y PM|!~!~<0 0\"|=0 8\"|>0 4\"|?0 >\""
    "|@0 2\"|A0 6\"|B0 :\"|C0 <\"|!~!~!(Z  R|!~!~!~JH- 0?|&(Z PL|'(Z  L| () "
    "P$|)$ V%|\"()  &|#() 0&|!~-(Z PK|!~!~!~1$ T%|2(Z 0M|!~!~5(Z  V|.() P\"|"
    "7(Z  M|8(Z  N|9(Z @M|:(Z 0N|;(Z PM|!~!~ 0 F|!~\"0 P|#0 R|!~!~<$ 0\"|=$ "
    "8\"|>$ 4\"|?$ >\"|@$ 2\"|A$ 6\"|B$ :\"|C$ <\"|.0 6| (D P$|!(D @=|\"(D  "
    "&|#(D 0&|$$ B\"|%(D PW|!~!~((D  9|!~*(D @1|+(D 01|,$ H\"|<0 0\"|=0 8\"|"
    ">0 4\"|?0 >\"|@0 2\"|A0 6\"|B0 :\"|C0 <\"| $ *#|!~!~!~$$ N$|!~J0 Z#|!~!"
    "(\\  R|)$ R$|!~ $ *#|!HH 0B|&(\\ PL|'(\\  L|$$ B\"|)$ V%|&$ <#|!~!~-(\\"
    " PK|!~6$ *!|,$ H\"|1$ T%|2(\\ 0M|/$ 8#|0$ :#|5(\\  V|!~7(\\  M|8(\\  N|"
    "9(\\ @M|:(\\ 0N|;(\\ PM|!~!~!~F$ \"%|G$  %|!~ H9 P$|!H9 @=|\"H9  &|#H9 "
    "0&|$H9 @-|%H9 PW|!~'H9 @5|(H9 @.|!~!~)- F\"|*- D\"|!~!~!~!~T- .\"|[, P$"
    "|\\, J$|], ^$|^, T$|_, \\$| - Z$|!~7- @\"|!~$- 2&|!0 0&|[, 6#|!~!~!~&0 "
    "F%|'0 @%| 0 F|DH9 0-|\"0 P|#0 R|!~-0 >%|!~!~)- .#|*- ,#|2$ J%|!~!~50 P&"
    "|.0 6|7$ H%|8$ P%|9$ L%|:$ R%|;$ N%|5- 4#|!~ H, P$|!~\"H,  &|#H, 0&|;- "
    "0#|<- 2#|<0 0\"|=0 8\"|>0 4\"|?0 >\"|@0 2\"|A0 6\"|B0 :\"|C0 <\"|.H, P\""
    "|!~ (4 P$|!(4 @=|\"(4  &|#(4 0&|J(. 0?|%(4 PW| (. P$|!~\"(.  &|#(. 0&|*"
    "(4 @1|+(4 01|<H,  2|=H,  3|>H, @2|?H, P3|@H, 02|AH, P2|BH, 03|CH, @3|.("
    ". P\"|!~ 0 F|!$ L#|\"H@  &|#H@ 0&|JH, 0?|%0 ^&| (- P$|!~\"(-  &|#(- 0&|"
    "*H@ @1|+H@ 01|<(.  2|=(.  3|>(. @2|?(. P3|@(. 02|A(. P2|B(. 03|C(. @3|."
    "(- P\"|!~ (C P$|!(C @=|\"(C  &|#(C 0&|J(. 0?|%(C PW|!~!~((C  9|!~*(C @1"
    "|+(C 01|<(-  2|=(-  3|>(- @2|?(- P3|@(- 02|A(- P2|B(- 03|C(- @3|!~!~!0 "
    "0&|!~!~!~J(- 0?|&0 F%|'0 @%| H* P$|)$ V%|\"H*  &|#H* 0&|!~-0 >%|!~!~!~1"
    "$ T%|20 J%|!~!~50 P&|.H* P\"|70 H%|80 P%|90 L%|:0 R%|;0 N%|!~!~!~!~!~!~"
    "!~!~<H*  2|=H*  3|>H* @2|?H* P3|@H* 02|AH* P2|BH* 03|CH* @3| (< P$|!(< "
    "@=|\"(<  &|#(< 0&|$(< @-|%(< PW|!~'(< @5|((< @.|!~!~!~!~!~!~!~ (/ P$|1("
    "< P/|\"(/  &|#(/ 0&|4(< @/|!~!~!~ (+ P$|!~\"(+  &|#(+ 0&|!~!~.(/ P\"|!~"
    " H4 P$|!H4 @=|\"H4  &|#H4 0&|D(< 0-|%H4 PW|.(+ P\"|!~($ (#|I(<  0|*H4 @"
    "1|+H4 01|<(/  2|=(/  3|>(/ @2|?(/ P3|@(/ 02|A(/ P2|B(/ 03|C(/ @3|<(+  2"
    "|=(+  3|>(+ @2|?(+ P3|@(+ 02|A(+ P2|B(+ 03|C(+ @3| H+ P$| $ *#|\"H+  &|"
    "#H+ 0&|!~$$ N$|!~!~!~!~)$ R$|!~!~ H. P$|.H+ P\"|\"H.  &|#H. 0&|!~!~!~!~"
    "!~!~6$ *!|!~!~!~.H. P\"|<H+  2|=H+  3|>H+ @2|?H+ P3|@H+ 02|AH+ P2|BH+ 0"
    "3|CH+ @3|!~!~!~F$ \"%|G$  %|<H.  2|=H.  3|>H. @2|?H. P3|@H. 02|AH. P2|B"
    "H. 03|CH. @3| H; P$|!H; @=|\"H;  &|#H; 0&|$H; @-|%H; PW|!~'H; @5|(H; @."
    "|!~!~[, P$|\\, J$|], ^$|^, T$|_, \\$| - 8&|1H; P/|!~!~4H; @/|!~ (; P$|!"
    "(; @=|\"(;  &|#(; 0&|$(; @-|%(; PW| $ *#|'(; @5|((; @.|!~$$ N$|!~!~!~DH"
    "; 0-|)$ R$|!~1(; P/|!~IH;  0|4(; @/| (0 P$|!~\"(0  &|#(0 0&|!~!~!~6$ *!"
    "| H0 P$|!~\"H0  &|#H0 0&|!~!~.(0 P\"|D(; 0-| (T P$|!(T @=|\"(T  &|#(T 0"
    "&|I(;  0|%(T PW|.H0 P\"|F$ \"%|G$  %|!~*(T @1|+(T 01|<(0  2|=(0  3|>(0 "
    "@2|?(0 P3|@(0 02|A(0 P2|B(0 03|C(0 @3|<H0  2|=H0  3|>H0 @2|?H0 P3|@H0 0"
    "2|AH0 P2|BH0 03|CH0 @3|[, P$|\\, J$|], ^$|^, T$|_, \\$| - 6&| H/ P$|!~\""
    "H/  &|#H/ 0&| H: P$|!H: @=|\"H:  &|#H: 0&|$H: @-|%H: PW|!~'H: @5|(H: @."
    "|!~.H/ P\"|!~ $ *#|!~!~!~$$ N$|1$ ^!|!~!~4$ \\!|)$ R$|!~!~<H/  2|=H/  3"
    "|>H/ @2|?H/ P3|@H/ 02|AH/ P2|BH/ 03|CH/ @3|!~!~6$ *!|!~DH: 0-|!~!~ $ *#"
    "|!~I$  \"|!~$$ N$|!~ $ *#| (# P$|!~)$ R$|$$ N$|F$ \"%|G$  %|!~ 0 F|)$ R"
    "$|\"0 P|#0 R|!~%0 ^&|!~.(# P\"|6$ *!|!~*0 ,\"|+0 *\"|!~!~6$ *!|!~!~!~[,"
    " P$|\\, J$|], ^$|^, T$|_, \\$| - :&|F$ \"%|G$  %|!~!~!~!~F$ \"%|G$  %|!"
    "~H(# P!|!~!~K$ D|L$ >|M$ @|!~O$ B|P$ <|!~!~!~[, P$|\\, J$|], ^$|^, T$|_"
    ", \\$| - <&|[, P$|\\, J$|], ^$|^, T$|_, \\$| - >&| H) P$| $ *#|\"H)  &|"
    "#H) 0&|!~$$ N$|!~!~!~!~)$ R$|!~!~!~.H) P\"| $ *#|!~!~!~$$ N$|!~!~!~6$ *"
    "!|)$ R$|!~!~!~<H)  2|=H)  3|>H) @2|?H) P3|@H) 02|AH) P2|BH) 03|CH) @3|!"
    "~6$ R(|!~F$ \"%|G$  %|!~!~ $ *#|!~!~!~$$ N$|!~!~!~!~)$ R$|F$ \"%|G$  %|"
    "!~!~!~Z- :|!~[, P$|\\, J$|], ^$|^, T$|_, B&|6$ *!|!~!~!~!~!~!~!~!~[, P$"
    "|\\, J$|], T(|^, T$|_, B&| $ *#|!~F$ \"%|G$  %|$$ N$|!~ $ *#|!~!~)$ R$|"
    "$$ N$|!~!~!~!~)$ R$|!~!~!~!~!~!~6$ *!|[, P$|\\, J$|], ^$|^, T$|_, @&|6$"
    ...
    "\"%|G$  %|/(H  ;|0(H 0;|!~!~3(H  J|!~!~!~!~!~!~!~!~[, P$|\\, J$|], ^$|^"
    ", D&|!~!~[, P$|\\, J$|], ^$|^, F&| (9 P$|!(9 @=|\"(9  &|#(9 0&|$(9 @-|%"
    "(9 PW|!~'(9 @5|((9 @.| (8 P$|!(8 @=|\"(8  &|#(8 0&|$(8 @-|%(8 PW|!~'(8 "
    "@5|((8 @.| H8 P$|!H8 @=|\"H8  &|#H8 0&|$H8 @-|%H8 PW|!~'H8 @5|(H8 @.| ("
    "5 P$| (& P$|\"(5  &|#(5 0&|!~%(5 PW|!~ H& P$|($ T!|D(9 0-|*(5 @1|+(5 01"
    "|!~ (L 09|!(L 0B|.(& P\"|!~$(L 04|D(8 0-|&(L @;|!~.H& P\"|!~!~!~,(L  5|"
    "!~DH8 0-|/(L  ;|0(L 0;|!~!~3(L  J|!~!~!~E- 4$|!~!~!~!~H(& P!|!~!~K(& @$"
    "|L(& P#|M(&  $|HH& P!|O(& 0$|P(& @#|KH& @$|LH& P#|MH&  $|!~OH& 0$|PH& @"
    "#| (M 09|!(M 0B|!~!~$(M 04|!~&(M @;|!~!~!~!~!~,(M  5|!~!~/(M  ;|0(M 0;|"
    " (N 09|!(N 0B|3(M  J|!~$(N 04|!~&(N @;|!~!~2- N#|!~!~,(N  5|!~!~/(N  ;|"
    "0(N 0;| (I 09|!(I 0B|3(N  J|!~$(I 04|!~&(I @;|!~!~!~!~!~,(I  5|!~!~/(I "
    " ;|0(I 0;|!~!~3(I  J| HC P$|!HC @=|\"HC  &|#HC 0&|!~%HC PW| H# P$|!~(HC"
    "  9|!~*HC @1|+HC 01| HF 09|!HF 0B|!~!~$HF 04|!~&HF @;|\"$ T#|.H# P\"|!~"
    " (% P$|!~,HF  5|!~)$ H#|/HF  ;|0HF 0;| HM 09|!HM 0B|3HF  J|!~$HM 04|!~&"
    "HM @;|.(% P\"|!~ H$ P$|6$ >#|!~,HM  5|!~!~/HM  ;|0HM 0;|HH# P!|!~3HM  J"
    "|KH# @$|LH# P#|MH#  $|.H$ P\"|OH# 0$|PH# @#|!~!~!~!~!~!~!~H(% P!|!~!~K("
    "% @$|L(% P#|M(%  $|S$ V#|O(% 0$|P(% @#|!~!~!~!~!~!~!~HH$ P!|!~!~KH$ @$|"
    "LH$ P#|MH$  $| H% P$|OH$ 0$|PH$ @#| HL 09|!HL 0B|(- 8$|!~$HL 04|!~&HL @"
    ";|-- >$|!~!~!~.H% P\"|,HL  5|!~4- @$|/HL  ;|0HL 0;| HK 09|!HK 0B|3HL  J"
    "|!~$HK 04|!~&HK @;|!~!~!~!~!~,HK  5|!~!~/HK  ;|0HK 0;|!~!~3HK  J|HH% P!"
    "|!~!~KH% @$|LH% P#|MH%  $|!~OH% 0$|PH% @#| (K 09|!(K 0B|!~!~$(K 04|!~&("
    "K @;|!~!~!~!~!~,(K  5|!~!~/(K  ;|0(K 0;|!~!~3(K  J|!~!~!~!~!~!~!~!~!~!~"
    "!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!"
    "~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~"
    "!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~!~}8|!|"
    "}9||}:||};|_#|}<||}=|(|}>|'|}?||}@|+|}A|_#|}B||}C|3|}D|_'|}E||}F|<|}G|_"
    "'|}H|Null||Halt|!|Label|\"|Call|#|ScanStart|$|ScanChar|%|ScanAccept|&|S"
    "canToken|'|ScanError|(|AstStart|)|AstFinish|*|AstNew|+|AstForm|,|AstLoa"
    "d|-|AstIndex|.|AstChild|/|AstChildSlice|0|AstKind|1|AstKindNum|2|AstLoc"
    "ation|3|AstLocationNum|4|AstLexeme|5|AstLexemeString|6|Assign|7|DumpSta"
    "ck|8|Add|9|Subtract|:|Multiply|;|Divide|<|UnaryMinus|=|Return|>|Branch|"
    "?|BranchEqual|@|BranchNotEqual|A|BranchLessThan|B|BranchLessEqual|C|Bra"
    "nchGreaterThan|D|BranchGreaterEqual|E|}I|37|}J|G1!|}K|7|!~|'||>|!~\"|$|"
    "!~\"|%|!~\"|P|)|-|$|@|@|$|A|A|&|B|B|(|D|D|.|E|E|0|F|F|2|G|G|4|H|H|?|I|I"
=!|!!|:!|=!|?!|?!|=!|A!|Z!|=!|&|GK|KW|H|=&|%|!~MW|$|P|Y"
    "|=!|!!|:!|=!|?!|?!|=!|A!|Z!|=!|&|>'|ZW||=&|%|!~\\W|&|P|Y|=!|!!|:!|=!|?!"
    "|?!|=!|A!|T!|=!|U!|U!|7&|V!|Z!|=!|&|>'|/X||=&|%|!~1X|&|P|Y|=!|!!|:!|=!|"
    "?!|?!|=!|A!|D!|=!|E!|E!|9&|F!|Z!|=!|&|\\S\"|DX|V|=&|%|!~FX|$|P|Y|=!|!!|"
    ":!|=!|?!|?!|=!|A!|Z!|=!|&|J/!|SX|'|=&|%|!~UX||'|!~VX|9|!~VX|'|'|!|>|!~Y"
    "X|(|W,|YX|!|>|W,|ZX|(|D1|ZX|\"|>|D1|[X|7|R4|[X|&|!|'|'4|]X|9|'4|]X|'|'|"
    "!|>|'4| Y|7|L5| Y|&||'|!5|\"Y|9|!5|\"Y|'|'|!|>|!5|%Y|)|B:|%Y|\"|+|B:|&Y"
    "|#|+|5;|'Y|$|-|J;|(Y||\"|#~0|L;|+Y|||!~,|5;|.Y|\"|$|#|2|6;|1Y|#|-|F;|2Y"
    "||\"|#~3|E;|5Y||+|2<|6Y|$|-|F<|7Y||\"|\"~0|H<|:Y|||!~,|2<|=Y|\"|$|#|2|3"
    "<|@Y|$|-|B<|AY||\"|\"~3|A<|DY||+|.=|EY|$|-|A=|FY||\"|!~0|C=|IY|||!~,|.="
    "|LY|\"|$|#|2|/=|OY|%|-|==|PY||\"|!~3|<=|SY||,|B:|TY|\"|#|#|2|C:|WY|\"|-"
    "|P:|XY||\"|!~3|O:|[Y||*|B:|\\Y|#|>|&8|]Y|)|?8|]Y|$|+|?8|^Y|#|,|?8|_Y|$|"
    "#||2|?8|\"Z| \"|*|?8|#Z||>|?8|$Z|)|,9|$Z|\"|+|,9|%Z|#|,|,9|&Z|\"|#||2|,"
    "9|)Z| \"|*|,9|*Z||>|,9|+Z|)|D@|+Z|$|+|D@|,Z|#|-|U@|-Z||$|!~0|W@|0Z|||!~"
    ",|D@|3Z|$|#|\"|2|E@|6Z|#|*|D@|7Z|\"|>|7?|8Z|)|P?|8Z|\"|+|P?|9Z|#|-|P?|:"
    "Z||\"|\"~0|P?|=Z|||!~-|P?|@Z||\"|!~/|P?|CZ||,|P?|DZ|\"|#|\"|2|P?|GZ|_!|"
    "*|P?|HZ|\"|>|P?|IZ|)|P?|IZ|$|+|P?|JZ|#|,|P?|KZ|$|#||2|P?|NZ|_!|*|P?|OZ|"
    "|>|P?|PZ|)|6B|PZ|\"|+|6B|QZ|#|-|GB|RZ||\"|!~/|FB|UZ||,|6B|VZ|\"|#|#|2|7"
    "B|YZ|&|*|6B|ZZ|#|>|!A|[Z|)|%D|[Z|$|+|%D|\\Z|#|-|5D|]Z||$|!~/|4D| [||,|%"
    "D|![|$|#|#|2|&D|$[|(|*|%D|%[|#|>|QB|&[|)|XE|&[|\"|+|XE|'[|#|-|,F|([||\""
    "|!~/|+F|+[||,|XE|,[|\"|#|#|2|YE|/[|'|*|XE|0[|#|>|?D|1[|)|PG|1[|$|+|PG|2"
    "[|#|-|%H|3[||$|!~/|$H|6[||,|PG|7[|$|#|#|2|QG|:[|)|*|PG|;[|#|>|6F|<[|)|H"
    "I|<[|\"|+|HI|=[|#|-|\\I|>[||\"|!~/|[I|A[||,|HI|B[|\"|#|#|2|II|E[|*|*|HI"
    "|F[|#|>|/H|G[|)|9L|G[|$|+|9L|H[|#|-|IL|I[||$|!~0|KL|L[|||!~,|9L|O[|$|#|"
    "\"|2|:L|R[|$|*|9L|S[|\"|>|.K|T[|)|GK|T[|\"|+|GK|U[|#|-|GK|V[||\"|\"~0|G"
    "K|Y[|||!~-|GK|\\[||\"|!~/|GK|_[||,|GK| \\|\"|#|\"|2|GK|#\\|_!|*|GK|$\\|"
    "\"|>|GK|%\\|)|GK|%\\|$|+|GK|&\\|#|,|GK|'\\|$|#||2|GK|*\\|_!|*|GK|+\\||>"
    "|GK|,\\|)|[M|,\\|\"|+|[M|-\\|#|-|2N|.\\||\"|!~/|1N|1\\||+|5N|2\\|$|,|5N"
    "|3\\|\"|$|!|2|6N|6\\|,|,|[M|7\\|\"|#|!|2|\\M|:\\|+|*|[M|;\\|!|>|UL|<\\|"
    ")|)P|<\\|$|+|)P|=\\|#|-|@P|>\\||$|#~/|?P|A\\||+|CP|B\\|\"|-|]P|C\\||$|!"
    "~0|_P|F\\|||!~,|CP|I\\|$|\"|#|2|DP|L\\|,|-|YP|M\\||$|!~3|XP|P\\||,|)P|Q"
    "\\|$|#|#|2|*P|T\\|+|*|)P|U\\|#|>|RN|V\\|)|:O|V\\|\"|+|:O|W\\|#|-|:O|X\\"
    "||\"|\"~0|:O|[\\|||!~-|:O|^\\||\"|!~/|:O|!]||,|:O|\"]|\"|#|\"|2|:O|%]|_"
    "!|*|:O|&]|\"|>|:O|']|)|:O|']|$|+|:O|(]|#|,|:O|)]|$|#||2|:O|,]|_!|*|:O|-"
    "]||>|:O|.]|)|?R|.]|\"|+|?R|/]|#|-|SR|0]||\"|!~/|RR|3]||,|?R|4]|\"|#|#|2"
    "|@R|7]|-|*|?R|8]|#|>|*Q|9]|)|2T|9]|$|+|2T|:]|#|-|IT|;]||$|!~/|HT|>]||,|"
    "2T|?]|$|#|#|2|3T|B]|.|*|2T|C]|#|>|]R|D]|)|\"V|D]|\"|+|\"V|E]|#|+|6V|F]|"
    "$|+|FV|G]|%|,|FV|H]|\"|%|#|2|GV|K]|!|4|PV|L]|!~-|YV|M]||\"|!~/|XV|P]||,"
    "|6V|Q]|\"|$|#|2|7V|T]|0|,|\"V|U]|\"|#|#|2|#V|X]|/|*|\"V|Y]|#|>|ST|Z]|)|"
    "3X|Z]|%|+|3X|[]|$|-|HX|\\]||%|!~0|JX|_]|||!~,|3X|\"^|%|$|#|2|4X|%^|/|*|"
    "3X|&^|#|>|$W|'^|)|EW|'^|#|+|EW|(^|\"|-|EW|)^||#|\"~0|EW|,^|||!~-|EW|/^|"
    "|#|!~/|EW|2^||,|EW|3^|#|\"|\"|2|EW|6^|_!|*|EW|7^|\"|>|EW|8^|)|EW|8^|$|+"
    "|EW|9^|%|-|EW|:^||$|!~/|EW|=^||,|EW|>^|$|%|!|2|EW|A^|_!|*|EW|B^|!|>|EW|"
    "C^|)|5Z|C^|\"|+|5Z|D^|#|-|FZ|E^||\"|$~/|EZ|H^||-|JZ|I^||\"|!~/|IZ|L^||,"
    "|5Z|M^|\"|#|%|2|6Z|P^|0|*|5Z|Q^|%|>|TX|R^|)|W[|R^|%|+|W[|S^|$|-|)\\|T^|"
    "|%|!~/|(\\|W^||,|W[|X^|%|$|!|2|X[|[^|U|*|W[|\\^|!|>|TZ|]^|)|H]|]^|#|+|H"
    "]|^^|\"|-|^]|_^||#|!~/|]]|\"_||,|H]|#_|#|\"|#|2|I]|&_|1|*|H]|'_|#|>|3\\"
    "|(_|)|H_|(_|$|+|H_|)_|%|-|Z_|*_||$|\"~/|Y_|-_||,|H_|._|$|%|%|2|I_|1_|2|"
    "*|H_|2_|%|>|(^|3_|)|5!!|3_|\"|+|5!!|4_|#|-|G!!|5_||\"|!~/|F!!|8_||,|5!!"
    "|9_|\"|#|#|2|6!!|<_|3|*|5!!|=_|#|>|$ !|>_|)|\"#!|>_|%|+|\"#!|?_|$|-|4#!"
    "|@_||%|!~/|3#!|C_||,|\"#!|D_|%|$|#|2|##!|G_|4|*|\"#!|H_|#|>|Q!!|I_|)|M$"
    "!|I_|#|+|M$!|J_|\"|-|^$!|K_||#|!~/|]$!|N_||,|M$!|O_|#|\"|#|2|N$!|R_|5|*"
    "|M$!|S_|#|>|>#!|T_|)|4'!|T_|$|+|4'!|U_|%|-|C'!|V_||$|!~0|E'!|Y_|||!~,|4"
    "'!|\\_|$|%|\"|2|5'!|__|%|*|4'!|  !|\"|>|.&!|! !|)|G&!|! !|\"|+|G&!|\" !"
    "|#|,|G&!|# !|\"|#||2|G&!|& !| \"|*|G&!|' !||>|G&!|( !|)|.&!|( !|%|+|.&!"
    "|) !|$|-|.&!|* !||%|\"~0|.&!|- !|||!~-|.&!|0 !||%|!~/|.&!|3 !||,|.&!|4 "
    "!|%|$|\"|2|.&!|7 !|_!|*|.&!|8 !|\"|>|.&!|9 !|)|.&!|9 !|#|+|.&!|: !|\"|-"
    ...
    "8!!|#|,|%-!|9!!|%|#|\"|2|&-!|<!!|!|4|/-!|=!!|!~,| -!|>!!|%|$|\"|2| -!|A"
    "!!|!\"|*| -!|B!!|\"|>|U+!|C!!|)|;.!|C!!|\"|+|;.!|D!!|#|+|<.!|E!!|$|,|<."
    "!|F!!|\"|$||2|=.!|I!!|!|4|F.!|J!!|!~+|N.!|K!!|%|,|N.!|L!!|\"|%||2|O.!|O"
    "!!|!|4|X.!|P!!|!~,|;.!|Q!!|\"|#||2|;.!|T!!|!\"|*|;.!|U!!||>|>-!|V!!|)|<"
    "0!|V!!|$|+|<0!|W!!|%|-|N0!|X!!||$|\"~/|M0!|[!!||-|R0!|\\!!||$|!~0|T0!|_"
    "!!|||!~,|<0!|\"\"!|$|%|\"|2|=0!|%\"!|7|*|<0!|&\"!|\"|>|'/!|'\"!|)|@/!|'"
    "\"!|#|+|@/!|(\"!|\"|-|@/!|)\"!||#|\"~0|@/!|,\"!|||!~-|@/!|/\"!||#|!~/|@"
    "O!|A'!|!|-|JO!|B'!|!|$|!~0|LO!|E'!|!||!~,|DO!|H'!|$|\"|\"|2|DO!|K'!|\"\""
    "|*|DO!|L'!|\"|>|!~M'!|)|#O!|M'!|#|+|#O!|N'!|%|-|#O!|O'!|!|#|\"~0|#O!|R'"
    "!|!||!~-|#O!|U'!|!|#|!~/|#O!|X'!|!|,|#O!|Y'!|#|%|\"|2|#O!|\\'!|_!|*|#O!"
    "|]'!|\"|>|#O!|^'!|)|<O!|^'!|\"|-|=O!|_'!|\"|\"|!~/|<O!|\"(!|\"|*|<O!|#("
    "!|\"|>|!~$(!|)|-O!|$(!|$|+|-O!|%(!|%|,|-O!|&(!|$|%||2|-O!|)(!| \"|*|-O!"
    "|*(!||>|-O!|+(!|)|#O!|+(!|#|+|#O!|,(!|\"|,|#O!|-(!|#|\"||2|#O!|0(!|_!|*"
    "|#O!|1(!||>|#O!|2(!|)|!~2(!|%|+|!~3(!|$|,|!~4(!|%|$||2|!~7(!| \"|*|!~8("
    "!||>|!~9(!|)|RR!|9(!|\"|+|RR!|:(!|#|-|!S!|;(!|\"|\"|#~/| S!|>(!|\"|-|%S"
    "!|?(!|\"|\"|!~/|$S!|B(!|\"|,|RR!|C(!|\"|#|$|2|SR!|F(!|I|*|RR!|G(!|$|>|9"
    "Q!|H(!|)|7T!|H(!|$|+|7T!|I(!|%|-|FT!|J(!|\"|$|!~/|ET!|M(!|\"|+|IT!|N(!|"
    "#|,|IT!|O(!|$|#|\"|2|JT!|R(!|!|4|ST!|S(!|!~,|7T!|T(!|$|%|\"|2|8T!|W(!|I"
    "|*|7T!|X(!|\"|>|/S!|Y(!|)|*V!|Y(!|\"|+|*V!|Z(!|#|+|8V!|[(!|%|,|8V!|\\(!"
    "|\"|%|\"|2|9V!|_(!|!|4|BV!| )!|!~-|KV!|!)!|\"|\"|!~/|JV!|$)!|\"|,|*V!|%"
    ")!|\"|#|\"|2|+V!|()!|I|*|*V!|))!|\"|>|\"U!|*)!|)|WW!|*)!|$|+|WW!|+)!|%|"
    ",|WW!|,)!|$|%|!|2|XW!|/)!|X|-|(X!|0)!|\"|$|!~5|'X!|3)!|\"|*|WW!|4)!|!|>"
    "|UV!|5)!|)|:Y!|5)!|#|+|:Y!|6)!|\"|-|HY!|7)!|\"|#|!~/|GY!|:)!|\"|,|:Y!|;"
    ")!|#|\"|\"|2|;Y!|>)!|J|*|:Y!|?)!|\"|>|2X!|@)!|)|ZZ!|@)!|%|+|ZZ!|A)!|$|-"
    "|,[!|B)!|\"|%|!~/|+[!|E)!|\"|,|ZZ!|F)!|%|$|\"|2|[Z!|I)!|K|*|ZZ!|J)!|\"|"
    ">|RY!|K)!|)|=\\!|K)!|\"|+|=\\!|L)!|#|-|U\\!|M)!|\"|\"|!~/|T\\!|P)!|\"|,"
    "|=\\!|Q)!|\"|#|\"|2|>\\!|T)!|L|*|=\\!|U)!|\"|>|6[!|V)!|)|'^!|V)!|$|+|'^"
    "!|W)!|%|-|7^!|X)!|\"|$|!~/|6^!|[)!|\"|,|'^!|\\)!|$|%|\"|2|(^!|_)!|M|*|'"
    "^!| *!|\"|>|_\\!|!*!|)|H_!|!*!|#|+|H_!|\"*!|\"|-|^_!|#*!|\"|#|!~/|]_!|&"
    ...
    "4$\"|)+!|#|>|R\"\"|*+!|)|=&\"|*+!|#|+|=&\"|++!|%|,|=&\"|,+!|#|%||2|>&\""
    "|/+!|Y|6|J&\"|0+!||*|=&\"|1+!||>|@%\"|2+!|)|C(\"|2+!|$|+|C(\"|3+!|\"|,|"
    "C(\"|4+!|$|\"||2|D(\"|7+!|Z|6|X(\"|8+!||*|C(\"|9+!||>|F'\"|:+!|)|**\"|:"
    "+!|%|+|**\"|;+!|#|,|**\"|<+!|%|#|\"|2|+*\"|?+!|Z|-|@*\"|@+!|#|%|!~5|?*\""
    "|C+!|#|*|**\"|D+!|\"|>|%)\"|E+!|)|K+\"|E+!|\"|+|K+\"|F+!|$|,|K+\"|G+!|\""
    "|$|!|2|L+\"|J+!|Y|-|Y+\"|K+!|#|\"|!~5|X+\"|N+!|#|*|K+\"|O+!|!|>|J*\"|P+"
    "!|)|6-\"|P+!|#|-|7-\"|Q+!|$|#|\"~/|6-\"|T+!|$|*|6-\"|U+!|#|>|#,\"|V+!|)"
    "|R/\"|V+!|%|+|R/\"|W+!|$|-|,0\"|X+!|$|%|!~0|.0\"|[+!|$||!~,|R/\"|^+!|%|"
    "$|!|2|S/\"|!,!|M!|*|R/\"|\",!|!|>|J.\"|#,!|)|J.\"|#,!|\"|+|J.\"|$,!|#|-"
    "|J.\"|%,!|$|\"|\"~0|J.\"|(,!|$||!~-|J.\"|+,!|$|\"|!~/|J.\"|.,!|$|,|J.\""
    "|/,!|\"|#|\"|2|J.\"|2,!|_!|*|J.\"|3,!|\"|>|J.\"|4,!|)|J.\"|4,!|$|+|J.\""
    "|5,!|%|,|J.\"|6,!|$|%||2|J.\"|9,!|_!|*|J.\"|:,!||>|J.\"|;,!|)|T1\"|;,!|"
    "#|+|T1\"|<,!|\"|-|+2\"|=,!|$|#|$~/|*2\"|@,!|$|-|/2\"|A,!|$|#|\"~/|.2\"|"
    "D,!|$|,|T1\"|E,!|#|\"|$|2|U1\"|H,!|N!|-|'2\"|I,!|$|#|#~3|&2\"|L,!|$|*|T"
    "1\"|M,!|$|>|80\"|N,!|)|A3\"|N,!|%|+|A3\"|O,!|$|,|A3\"|P,!|%|$|\"|2|B3\""
    "|S,!|]!|*|A3\"|T,!|\"|>|92\"|U,!|)|U4\"|U,!|\"|+|U4\"|V,!|#|-|$5\"|W,!|"
    "$|\"|#~/|#5\"|Z,!|$|-|(5\"|[,!|$|\"|\"~/|'5\"|^,!|$|,|U4\"|_,!|\"|#|#|2"
    "|V4\"|\"-!|[!|*|U4\"|#-!|#|>|!~$-!|)|(6\"|$-!|$|+|(6\"|%-!|%|-|86\"|&-!"
    "|$|$|#~/|76\"|)-!|$|-|<6\"|*-!|$|$|\"~/|;6\"|--!|$|,|(6\"|.-!|$|%|#|2|)"
    "6\"|1-!|Z!|*|(6\"|2-!|#|>|!~3-!|)|<7\"|3-!|#|+|<7\"|4-!|\"|-|N7\"|5-!|$"
    "|#|#~/|M7\"|8-!|$|-|R7\"|9-!|$|#|\"~/|Q7\"|<-!|$|,|<7\"|=-!|#|\"|#|2|=7"
    "\"|@-!|O!|*|<7\"|A-!|#|>|!~B-!|)|R8\"|B-!|%|+|R8\"|C-!|$|-|'9\"|D-!|$|%"
    "|#~/|&9\"|G-!|$|-|+9\"|H-!|$|%|\"~/|*9\"|K-!|$|,|R8\"|L-!|%|$|#|2|S8\"|"
    "O-!|P!|*|R8\"|P-!|#|>|!~Q-!|)|+:\"|Q-!|\"|+|+:\"|R-!|#|-|@:\"|S-!|$|\"|"
    "#~/|?:\"|V-!|$|-|D:\"|W-!|$|\"|\"~/|C:\"|Z-!|$|,|+:\"|[-!|\"|#|#|2|,:\""
    "|^-!|Q!|*|+:\"|_-!|#|>|!~ .!|)|D;\"| .!|$|+|D;\"|!.!|%|-|Z;\"|\".!|$|$|"
    "#~/|Y;\"|%.!|$|-|^;\"|&.!|$|$|\"~/|];\"|).!|$|,|D;\"|*.!|$|%|#|2|E;\"|-"
    ...
    "?A\"|!/!|$|-|DA\"|\"/!|$|$|\"~/|CA\"|%/!|$|,|+A\"|&/!|$|%|#|2|,A\"|)/!|"
    "V!|*|+A\"|*/!|#|>|!~+/!|)|DB\"|+/!|#|+|DB\"|,/!|\"|-|YB\"|-/!|$|#|#~/|X"
    "B\"|0/!|$|-|]B\"|1/!|$|#|\"~/|\\B\"|4/!|$|,|DB\"|5/!|#|\"|#|2|EB\"|8/!|"
    "W!|*|DB\"|9/!|#|>|!~:/!|)|]C\"|:/!|%|+|]C\"|;/!|$|-|0D\"|</!|$|%|#~/|/D"
    "\"|?/!|$|-|4D\"|@/!|$|%|\"~/|3D\"|C/!|$|,|]C\"|D/!|%|$|#|2|^C\"|G/!|X!|"
    "*|]C\"|H/!|#|>|!~I/!|)|HE\"|I/!|\"|+|HE\"|J/!|#|-|_E\"|K/!|$|\"|!~/|^E\""
    "|N/!|$|,|HE\"|O/!|\"|#|\"|2|IE\"|R/!|Y!|*|HE\"|S/!|\"|>|>D\"|T/!|)|3G\""
    "|T/!|$|+|3G\"|U/!|%|-|CG\"|V/!|$|$|!~/|BG\"|Y/!|$|,|3G\"|Z/!|$|%|\"|2|4"
    "G\"|]/!|\\!|*|3G\"|^/!|\"|>|)F\"|_/!|)|LI\"|_/!|#|-|MI\"| 0!|%|#|\"~/|L"
    "I\"|#0!|%|*|LI\"|$0!|#|>|<H\"|%0!|)|3L\"|%0!|\"|+|3L\"|&0!|%|,|3L\"|'0!"
    "|\"|%|!|2|4L\"|*0!|^!|*|3L\"|+0!|!|>|.K\"|,0!|)|VN\"|,0!|$|+|VN\"|-0!|#"
    "|,|VN\"|.0!|$|#|!|2|WN\"|10!|[|-|#O\"|20!|%|$|!~5|\"O\"|50!|%|*|VN\"|60"
    "!|!|>|VM\"|70!|)|4P\"|70!|%|+|4P\"|80!|\"|,|4P\"|90!|%|\"|!|2|5P\"|<0!|"
    "[|-|AP\"|=0!|%|%|!~5|@P\"|@0!|%|*|4P\"|A0!|!|>|-O\"|B0!|)|OQ\"|B0!|#|+|"
    "OQ\"|C0!|$|,|OQ\"|D0!|#|$|!|2|PQ\"|G0!|X|-| R\"|H0!|%|#|!~5|_Q\"|K0!|%|"
    "*|OQ\"|L0!|!|>|KP\"|M0!|)|+S\"|M0!|\"|+|+S\"|N0!|%|,|+S\"|O0!|\"|%|!|2|"
    ",S\"|R0!|Y|-|9S\"|S0!|%|\"|!~5|8S\"|V0!|%|*|+S\"|W0!|!|>|*R\"|X0!|)|AT\""
    "|X0!|$|+|AT\"|Y0!|#|,|AT\"|Z0!|$|#|!|2|BT\"|]0!|]|*|AT\"|^0!|!|>|CS\"|_"
    "0!|)|QU\"|_0!|%|+|QU\"| 1!|\"|,|QU\"|!1!|%|\"|!|2|RU\"|$1!|^|*|QU\"|%1!"
    "|!|>|RT\"|&1!|)|#W\"|&1!|#|+|#W\"|'1!|$|,|#W\"|(1!|#|$|!|2|$W\"|+1!|[|-"
    "|0W\"|,1!|%|#|!~5|/W\"|/1!|%|*|#W\"|01!|!|>|#V\"|11!|)|@X\"|11!|\"|+|@X"
    "\"|21!|%|,|@X\"|31!|\"|%|!|2|AX\"|61!|\\|-|SX\"|71!|%|\"|!~5|RX\"|:1!|%"
    "|*|@X\"|;1!|!|>|:W\"|<1!|)|!Z\"|<1!|$|+|!Z\"|=1!|#|,|!Z\"|>1!|$|#|!|2|\""
    "Z\"|A1!|X|-|2Z\"|B1!|%|$|!~5|1Z\"|E1!|%|*|!Z\"|F1!|!|>|]X\"|G1!|}L|(|}M"
    "||0|!|1||Temp$0||Temp$1||Temp$2||Temp$3||in_guard||token_count|}N|&|}O|"
    "#|}P|1|Missing closing quote on string literal|Missing closing quote on"
    " triple quoted string literal|}Q|}"
};
...
static const char* regex_str =
{
    ...
    "|!|!|!|!|!|!|!|!|!|!|!|!|!|!|!|!|!||^\"|3!||||||<!|!|N#|!||}*|<\"|\"\"|"
    ";\"| \"|!\"|@\"|A\"|%\"|'\"|(\"|)\"|*\"|+\"|,\"|-\"|.\"|/\"|0\"|2\"|3\""
    "|4\"|5\"|1\"|7\"|8\"|9\"|:\"|6\"|?\"|#\"|$\"|&\"|P\"-A||||P;N@||||P<N@|"
    ">\"||=\"|B\"|}+||||||!|!||||||||||||||||||||||!||||@\"|8#|_!||||||$||||"
    "!|},|I|}-|!|!|\"|\"|\"|!|!|!|\"|!|\"|\"|\"|#|!|!|!|!|!|!|!|!|!|!|!|!|!|"
    "!|!|!|!|!|!|!|!|!|!|!|!|!|!|}.|J|H|G|F|C|F|G|D|E|E|B|B|B|B|B|B|B|A|A|A|"
    "A|A|A|@|@|@|@|@|@|@|@|@|@|@|@|@|@|@|@|@|@|}/|*accept* ::= Regex|Regex :"
    ":= RegexOr|RegexOr ::= RegexOrTerm RegexOr:1|RegexOr:1 ::= RegexOr:1 Re"
    "gexOr:2|RegexOr:2 ::= '{',' RegexOrTerm|RegexOr:1 ::= RegexOr:2|RegexOr"
    " ::= RegexOrTerm|RegexOrTerm ::= RegexOrTerm:1|RegexOrTerm:1 ::= RegexO"
    "rTerm:1 RegexUnopTerm|RegexOrTerm:1 ::= RegexUnopTerm|RegexUnopTerm ::="
    " RegexUnopTerm '*'|RegexUnopTerm ::= RegexUnopTerm '+'|RegexUnopTerm ::"
    "= RegexUnopTerm '?'|RegexUnopTerm ::= '(' RegexOr ')'|RegexUnopTerm ::="
    " <macro>|RegexUnopTerm ::= Charset|RegexUnopTerm ::= Char|Charset ::= <"
    "charset>|Charset ::= '.'|Charset ::= '\\\\s'|Charset ::= '\\\\S'|Charse"
    "t ::= '\\\\d'|Charset ::= '\\\\D'|Char ::= <char>|Char ::= '\\\\\\\\'|C"
    "har ::= '$'|Char ::= '\\\\n'|Char ::= '\\\\r'|Char ::= '\\\\{','|Char :"
    ":= '\\\\*'|Char ::= '\\\\+'|Char ::= '\\\\?'|Char ::= '\\\\.'|Char ::= "
    "'\\\\$'|Char ::= '\\\\b'|Char ::= '\\\\('|Char ::= '\\\\)'|Char ::= '\\"
    "\\['|Char ::= '\\\\]'|Char ::= '\\\\{'+'|Char ::= '\\\\{'-'|}0|!~.!|6!|"
    "@!|J!|O!|!~W!|_!|)\"|1\"|9\"|A\"|I\"|N\"|!~!~V\"|^\"|$#|*#|0#|6#|<#|D#|"
    "J#|P#|V#|\\#|\"$|($|.$|4$|:$|@$|F$|L$|R$|X$|^$|$%|}1|\"|}2||}3|M|}4|R|}"
    "5|F|/!|O!|/\"|)!|,!|Q3|/$|R$|/%|W%|7&|O#|W&|7'|W'|7(|W(|7)|W)|7*|W*|7+|"
    "W+|7,|W,|7-|W-|7.|W.|7/|W/|70|W0|^3|L$|43|71|W1|72|W2|Q%|#!|!4|/#||$4|L"
    "%|Z3|O\"|}6|R4|}7| %|!!@%|\"!@$|#!0\"|$!(!|%!0|&!(|'!@!|(!0#|)!@#|*!H#|"
    "+!P\"|,!X\"|-!(#|.! #|/! \"|0!P!|1!P#|2!X#|3!8#|4!X!|5!8\"|6!(\"|7!H!|8"
    "! $|9!H\"|:!($|;!@\"|<!8|=!P$|>!X$|?! %|@#8!|A#0!|B#(&|C#X%|D# &|E#X|F#"
    "0$|G#P%|H#@|#!0\"|$!(!|%!0|&!(|'!@!|(!0#|)!@#|*!H#|+!P\"|,!X\"|-!(#|.! "
    "#|/! \"|0!P!|1!P#|2!X#|3!8#|4!X!|5!8\"|6!(\"|7!H!|8! $|9!H\"|:!($|;!@\""
    "|<!8| : H%|!: @%|\": @$|@#8!|A#0!|B# !| %|D#P|E#X| * H%|G#H|H#@| R!H%|!"
    "R!@%|\"R!@$|#R!0\"|$R!(!|%R!0|&R!(|'R!@!|(R!0#|)R!@#|*R!H#|+R!P\"|,R!X\""
    "|-R!(#|.R! #|/R! \"|0R!P!|1R!P#|2R!X#|3R!8#|4R!X!|5R!8\"|6R!(\"|7R!H!|8"
    "R! $|9R!H\"|:R!($|;R!@\"|<R!8|=R!P$|>R!X$|?R! %| *\"H%|!*\"@%|\"*\"@$|#"
    "*\"0\"|$*\"(!|%*\"0|&*\"(|'*\"@!|(*\"0#|)*\"@#|**\"H#|+*\"P\"|,*\"X\"|-"
